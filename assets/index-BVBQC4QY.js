const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/About-BbcSmuJ3.js","assets/vendor-motion-BoSVoJ0s.js","assets/vendor-react-DlBnNAMw.js","assets/vendor-styled-Du6AN5G6.js","assets/Section-Ozs3UCOt.js","assets/TechnologyProficiency-BE_43rhZ.js","assets/ProfessionalExperience-hiWDDqLG.js","assets/MostProudOf-4Wj9VA7W.js","assets/Certifications-DHNPBpdL.js","assets/Testimonials-B17594SN.js","assets/EducationalQualifications-Dvw7BmOj.js","assets/Contact-SOw553K0.js"])))=>i.map(i=>d[i]);
import{r as nt,j as x,m as C,A as Pm,u as th,a as df,b as bd}from"./vendor-motion-BoSVoJ0s.js";import{r as ah,a as lh}from"./vendor-react-DlBnNAMw.js";import{f as eh,m as Ta,d as O,l as nh}from"./vendor-styled-Du6AN5G6.js";(function(){const B=document.createElement("link").relList;if(B&&B.supports&&B.supports("modulepreload"))return;for(const D of document.querySelectorAll('link[rel="modulepreload"]'))g(D);new MutationObserver(D=>{for(const q of D)if(q.type==="childList")for(const it of q.addedNodes)it.tagName==="LINK"&&it.rel==="modulepreload"&&g(it)}).observe(document,{childList:!0,subtree:!0});function V(D){const q={};return D.integrity&&(q.integrity=D.integrity),D.referrerPolicy&&(q.referrerPolicy=D.referrerPolicy),D.crossOrigin==="use-credentials"?q.credentials="include":D.crossOrigin==="anonymous"?q.credentials="omit":q.credentials="same-origin",q}function g(D){if(D.ep)return;D.ep=!0;const q=V(D);fetch(D.href,q)}})();var mf={exports:{}},xn={},hf={exports:{}},gf={};var Sd;function ih(){return Sd||(Sd=1,(function(S){function B(v,z){var _=v.length;v.push(z);t:for(;0<_;){var ut=_-1>>>1,ct=v[ut];if(0<D(ct,z))v[ut]=z,v[_]=ct,_=ut;else break t}}function V(v){return v.length===0?null:v[0]}function g(v){if(v.length===0)return null;var z=v[0],_=v.pop();if(_!==z){v[0]=_;t:for(var ut=0,ct=v.length,jt=ct>>>1;ut<jt;){var rt=2*(ut+1)-1,F=v[rt],zt=rt+1,ba=v[zt];if(0>D(F,_))zt<ct&&0>D(ba,F)?(v[ut]=ba,v[zt]=_,ut=zt):(v[ut]=F,v[rt]=_,ut=rt);else if(zt<ct&&0>D(ba,_))v[ut]=ba,v[zt]=_,ut=zt;else break t}}return z}function D(v,z){var _=v.sortIndex-z.sortIndex;return _!==0?_:v.id-z.id}if(S.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var q=performance;S.unstable_now=function(){return q.now()}}else{var it=Date,G=it.now();S.unstable_now=function(){return it.now()-G}}var L=[],w=[],dt=1,T=null,W=3,Bt=!1,k=!1,qt=!1,Ja=!1,Ea=typeof setTimeout=="function"?setTimeout:null,ma=typeof clearTimeout=="function"?clearTimeout:null,Mt=typeof setImmediate<"u"?setImmediate:null;function Lt(v){for(var z=V(w);z!==null;){if(z.callback===null)g(w);else if(z.startTime<=v)g(w),z.sortIndex=z.expirationTime,B(L,z);else break;z=V(w)}}function aa(v){if(qt=!1,Lt(v),!k)if(V(L)!==null)k=!0,va||(va=!0,la());else{var z=V(w);z!==null&&Da(aa,z.startTime-v)}}var va=!1,Ma=-1,ha=5,Yl=-1;function zn(){return Ja?!0:!(S.unstable_now()-Yl<ha)}function Ql(){if(Ja=!1,va){var v=S.unstable_now();Yl=v;var z=!0;try{t:{k=!1,qt&&(qt=!1,ma(Ma),Ma=-1),Bt=!0;var _=W;try{a:{for(Lt(v),T=V(L);T!==null&&!(T.expirationTime>v&&zn());){var ut=T.callback;if(typeof ut=="function"){T.callback=null,W=T.priorityLevel;var ct=ut(T.expirationTime<=v);if(v=S.unstable_now(),typeof ct=="function"){T.callback=ct,Lt(v),z=!0;break a}T===V(L)&&g(L),Lt(v)}else g(L);T=V(L)}if(T!==null)z=!0;else{var jt=V(w);jt!==null&&Da(aa,jt.startTime-v),z=!1}}break t}finally{T=null,W=_,Bt=!1}z=void 0}}finally{z?la():va=!1}}}var la;if(typeof Mt=="function")la=function(){Mt(Ql)};else if(typeof MessageChannel<"u"){var An=new MessageChannel,De=An.port2;An.port1.onmessage=Ql,la=function(){De.postMessage(null)}}else la=function(){Ea(Ql,0)};function Da(v,z){Ma=Ea(function(){v(S.unstable_now())},z)}S.unstable_IdlePriority=5,S.unstable_ImmediatePriority=1,S.unstable_LowPriority=4,S.unstable_NormalPriority=3,S.unstable_Profiling=null,S.unstable_UserBlockingPriority=2,S.unstable_cancelCallback=function(v){v.callback=null},S.unstable_forceFrameRate=function(v){0>v||125<v?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ha=0<v?Math.floor(1e3/v):5},S.unstable_getCurrentPriorityLevel=function(){return W},S.unstable_next=function(v){switch(W){case 1:case 2:case 3:var z=3;break;default:z=W}var _=W;W=z;try{return v()}finally{W=_}},S.unstable_requestPaint=function(){Ja=!0},S.unstable_runWithPriority=function(v,z){switch(v){case 1:case 2:case 3:case 4:case 5:break;default:v=3}var _=W;W=v;try{return z()}finally{W=_}},S.unstable_scheduleCallback=function(v,z,_){var ut=S.unstable_now();switch(typeof _=="object"&&_!==null?(_=_.delay,_=typeof _=="number"&&0<_?ut+_:ut):_=ut,v){case 1:var ct=-1;break;case 2:ct=250;break;case 5:ct=1073741823;break;case 4:ct=1e4;break;default:ct=5e3}return ct=_+ct,v={id:dt++,callback:z,priorityLevel:v,startTime:_,expirationTime:ct,sortIndex:-1},_>ut?(v.sortIndex=_,B(w,v),V(L)===null&&v===V(w)&&(qt?(ma(Ma),Ma=-1):qt=!0,Da(aa,_-ut))):(v.sortIndex=ct,B(L,v),k||Bt||(k=!0,va||(va=!0,la()))),v},S.unstable_shouldYield=zn,S.unstable_wrapCallback=function(v){var z=W;return function(){var _=W;W=z;try{return v.apply(this,arguments)}finally{W=_}}}})(gf)),gf}var xd;function uh(){return xd||(xd=1,hf.exports=ih()),hf.exports}var zd;function ch(){if(zd)return xn;zd=1;var S=uh(),B=ah(),V=lh();function g(t){var a="https://react.dev/errors/"+t;if(1<arguments.length){a+="?args[]="+encodeURIComponent(arguments[1]);for(var l=2;l<arguments.length;l++)a+="&args[]="+encodeURIComponent(arguments[l])}return"Minified React error #"+t+"; visit "+a+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function D(t){return!(!t||t.nodeType!==1&&t.nodeType!==9&&t.nodeType!==11)}function q(t){var a=t,l=t;if(t.alternate)for(;a.return;)a=a.return;else{t=a;do a=t,(a.flags&4098)!==0&&(l=a.return),t=a.return;while(t)}return a.tag===3?l:null}function it(t){if(t.tag===13){var a=t.memoizedState;if(a===null&&(t=t.alternate,t!==null&&(a=t.memoizedState)),a!==null)return a.dehydrated}return null}function G(t){if(t.tag===31){var a=t.memoizedState;if(a===null&&(t=t.alternate,t!==null&&(a=t.memoizedState)),a!==null)return a.dehydrated}return null}function L(t){if(q(t)!==t)throw Error(g(188))}function w(t){var a=t.alternate;if(!a){if(a=q(t),a===null)throw Error(g(188));return a!==t?null:t}for(var l=t,e=a;;){var n=l.return;if(n===null)break;var i=n.alternate;if(i===null){if(e=n.return,e!==null){l=e;continue}break}if(n.child===i.child){for(i=n.child;i;){if(i===l)return L(n),t;if(i===e)return L(n),a;i=i.sibling}throw Error(g(188))}if(l.return!==e.return)l=n,e=i;else{for(var u=!1,c=n.child;c;){if(c===l){u=!0,l=n,e=i;break}if(c===e){u=!0,e=n,l=i;break}c=c.sibling}if(!u){for(c=i.child;c;){if(c===l){u=!0,l=i,e=n;break}if(c===e){u=!0,e=i,l=n;break}c=c.sibling}if(!u)throw Error(g(189))}}if(l.alternate!==e)throw Error(g(190))}if(l.tag!==3)throw Error(g(188));return l.stateNode.current===l?t:a}function dt(t){var a=t.tag;if(a===5||a===26||a===27||a===6)return t;for(t=t.child;t!==null;){if(a=dt(t),a!==null)return a;t=t.sibling}return null}var T=Object.assign,W=Symbol.for("react.element"),Bt=Symbol.for("react.transitional.element"),k=Symbol.for("react.portal"),qt=Symbol.for("react.fragment"),Ja=Symbol.for("react.strict_mode"),Ea=Symbol.for("react.profiler"),ma=Symbol.for("react.consumer"),Mt=Symbol.for("react.context"),Lt=Symbol.for("react.forward_ref"),aa=Symbol.for("react.suspense"),va=Symbol.for("react.suspense_list"),Ma=Symbol.for("react.memo"),ha=Symbol.for("react.lazy"),Yl=Symbol.for("react.activity"),zn=Symbol.for("react.memo_cache_sentinel"),Ql=Symbol.iterator;function la(t){return t===null||typeof t!="object"?null:(t=Ql&&t[Ql]||t["@@iterator"],typeof t=="function"?t:null)}var An=Symbol.for("react.client.reference");function De(t){if(t==null)return null;if(typeof t=="function")return t.$$typeof===An?null:t.displayName||t.name||null;if(typeof t=="string")return t;switch(t){case qt:return"Fragment";case Ea:return"Profiler";case Ja:return"StrictMode";case aa:return"Suspense";case va:return"SuspenseList";case Yl:return"Activity"}if(typeof t=="object")switch(t.$$typeof){case k:return"Portal";case Mt:return t.displayName||"Context";case ma:return(t._context.displayName||"Context")+".Consumer";case Lt:var a=t.render;return t=t.displayName,t||(t=a.displayName||a.name||"",t=t!==""?"ForwardRef("+t+")":"ForwardRef"),t;case Ma:return a=t.displayName||null,a!==null?a:De(t.type)||"Memo";case ha:a=t._payload,t=t._init;try{return De(t(a))}catch{}}return null}var Da=Array.isArray,v=B.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,z=V.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,_={pending:!1,data:null,method:null,action:null},ut=[],ct=-1;function jt(t){return{current:t}}function rt(t){0>ct||(t.current=ut[ct],ut[ct]=null,ct--)}function F(t,a){ct++,ut[ct]=t.current,t.current=a}var zt=jt(null),ba=jt(null),ka=jt(null),Tn=jt(null);function En(t,a){switch(F(ka,a),F(ba,t),F(zt,null),a.nodeType){case 9:case 11:t=(t=a.documentElement)&&(t=t.namespaceURI)?Xr(t):0;break;default:if(t=a.tagName,a=a.namespaceURI)a=Xr(a),t=Zr(a,t);else switch(t){case"svg":t=1;break;case"math":t=2;break;default:t=0}}rt(zt),F(zt,t)}function Xl(){rt(zt),rt(ba),rt(ka)}function Ki(t){t.memoizedState!==null&&F(Tn,t);var a=zt.current,l=Zr(a,t.type);a!==l&&(F(ba,t),F(zt,l))}function Mn(t){ba.current===t&&(rt(zt),rt(ba)),Tn.current===t&&(rt(Tn),pn._currentValue=_)}var Ji,pf;function xl(t){if(Ji===void 0)try{throw Error()}catch(l){var a=l.stack.trim().match(/\n( *(at )?)/);Ji=a&&a[1]||"",pf=-1<l.stack.indexOf(`
...
`,Dd=nt.createContext(void 0),Od="portfolio-theme-mode",mh=()=>{if(typeof window<"u"){const S=localStorage.getItem(Od);if(S==="dark"||S==="light")return S}return"dark"},hh=({children:S})=>{const[B,V]=nt.useState(mh);nt.useEffect(()=>{document.documentElement.setAttribute("data-theme",B),localStorage.setItem(Od,B)},[B]);const g=()=>{V(D=>D==="dark"?"light":"dark")};return x.jsx(Dd.Provider,{value:{mode:B,toggleTheme:g,isDark:B==="dark"},children:S})},gh=()=>{const S=nt.useContext(Dd);if(!S)throw new Error("useTheme must be used within a ThemeProvider");return S},yh=Ta`
  0% {
...
`,Ed=[{label:"About",href:"#about"},{label:"Skills",href:"#technologyproficiency"},{label:"Experience",href:"#professionalexperience"},{label:"Projects",href:"#mostproudof"},{label:"Contact",href:"#contact"}],Mh=()=>{const[S,B]=nt.useState(""),V=nt.useRef(null),{isDark:g,toggleTheme:D}=gh();nt.useEffect(()=>{const G=()=>{const L=Ed.map(w=>w.href.replace("#",""));for(const w of[...L].reverse()){const dt=document.getElementById(w);if(dt&&dt.getBoundingClientRect().top<=150){B(w);return}}B("")};return window.addEventListener("scroll",G,{passive:!0}),()=>window.removeEventListener("scroll",G)},[]);const q=G=>{const L=G.currentTarget.getBoundingClientRect(),w=(G.clientX-L.left)/L.width*100,dt=(G.clientY-L.top)/L.height*100;G.currentTarget.style.setProperty("--mouse-x",`${w}%`),G.currentTarget.style.setProperty("--mouse-y",`${dt}%`)},it=(G,L)=>{G.preventDefault(),document.querySelector(L)?.scrollIntoView({behavior:"smooth"})};return x.jsx(vh,{ref:V,children:x.jsxs(bh,{"aria-label":"Main navigation",initial:{opacity:0,y:-20,scale:.95},animate:{opacity:1,y:0,scale:1},transition:{duration:.6,ease:[.25,.1,.25,1],delay:.2},children:[x.jsx(Sh,{href:"#home",onClick:G=>it(G,"#home"),whileHover:{scale:1.05},whileTap:{scale:.95},children:x.jsxs("picture",{children:[x.jsx("source",{srcSet:"/images/logo-100.webp",type:"image/webp"}),x.jsx(xh,{src:"/images/logo-optimized.png",alt:"PN",width:28,height:28,loading:"eager",decoding:"async"})]})}),x.jsx(zh,{children:Ed.map(G=>{const L=S===G.href.replace("#","");return x.jsxs(Ah,{href:G.href,$isActive:L,"aria-current":L?"page":void 0,onClick:w=>it(w,G.href),onMouseMove:q,whileHover:{scale:1.02},whileTap:{scale:.98},children:[L&&x.jsx(Th,{layoutId:"navActive",initial:!1,transition:{type:"spring",stiffness:500,damping:35}}),x.jsx("span",{style:{position:"relative",zIndex:1},children:G.label})]},G.label)})}),x.jsx(Eh,{onClick:D,whileHover:{scale:1.05},whileTap:{scale:.95},title:g?"Switch to light mode":"Switch to dark mode","aria-label":g?"Switch to light mode":"Switch to dark mode",role:"button",children:x.jsx(Pm,{mode:"wait",children:g?x.jsxs(C.svg,{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",initial:{rotate:-90,opacity:0},animate:{rotate:0,opacity:1},exit:{rotate:90,opacity:0},transition:{duration:.3},children:[x.jsx("circle",{cx:"12",cy:"12",r:"5"}),x.jsx("path",{d:"M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"})]},"sun"):x.jsx(C.svg,{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",initial:{rotate:90,opacity:0},animate:{rotate:0,opacity:1},exit:{rotate:-90,opacity:0},transition:{duration:.3},children:x.jsx("path",{d:"M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"})},"moon")})})]})})},Ud=Ta`
  0% {
...
`,kh={initial:{opacity:1},animate:{opacity:1},exit:{opacity:0,transition:{duration:.2,ease:"easeOut"}}},$h={initial:{opacity:0,scale:1.5},animate:{opacity:1,scale:1,transition:{duration:1.5}},exit:{opacity:0,scale:.95,transition:{duration:.2}}},Wh={initial:{},animate:{},exit:{scale:.9,opacity:0,transition:{duration:.2,ease:"easeOut"}}},Fh={initial:{opacity:0,scale:.5},animate:{opacity:1,scale:1,transition:{duration:.8,ease:[.25,.1,.25,1]}}},Ih={initial:{opacity:0,scale:0,rotate:-180},animate:{opacity:1,scale:1,rotate:0,transition:{type:"spring",stiffness:100,damping:15,delay:.2}}},Ph={initial:{opacity:0,scale:.3,rotateY:-90,filter:"blur(10px)"},animate:{opacity:1,scale:1,rotateY:0,filter:"blur(0px)",transition:{type:"spring",stiffness:80,damping:12,delay:.4}}},tg=({onComplete:S})=>{const[B,V]=nt.useState("animate"),g=Array.from({length:20},(D,q)=>({id:q,x:Math.random()*100,y:Math.random()*100,size:Math.random()*4+2,color:q%3===0?"rgba(42, 157, 143, 0.4)":q%3===1?"rgba(59, 180, 177, 0.3)":"rgba(67, 97, 165, 0.3)",duration:Math.random()*3+2,delay:Math.random()*2}));return nt.useEffect(()=>{const D=setTimeout(()=>{V("exit")},2200);return()=>clearTimeout(D)},[]),nt.useEffect(()=>{if(B==="exit"){const D=setTimeout(()=>{S()},200);return()=>clearTimeout(D)}},[B,S]),x.jsxs(Gh,{variants:kh,initial:"initial",animate:B,children:[x.jsx(Rh,{variants:$h,initial:"initial",animate:B}),x.jsx(Yh,{initial:{opacity:1},animate:{opacity:B==="exit"?0:1},transition:{duration:.2},children:g.map(D=>x.jsx(Qh,{$size:D.size,$color:D.color,style:{left:`${D.x}%`,top:`${D.y}%`},initial:{opacity:0,scale:0},animate:{opacity:[0,.8,0],scale:[0,1,0],y:[0,-100]},transition:{duration:D.duration,delay:D.delay,repeat:1/0,repeatDelay:Math.random()*2}},D.id))}),x.jsx(Xh,{variants:Wh,initial:"initial",animate:B,children:x.jsxs(Zh,{children:[x.jsx(Lh,{variants:Fh,initial:"initial",animate:"animate"}),x.jsx(yf,{}),x.jsx(yf,{}),x.jsx(yf,{}),x.jsx(Vh,{variants:Ih,initial:"initial",animate:"animate"}),x.jsxs("picture",{children:[x.jsx("source",{srcSet:"/images/logo-optimized.webp",type:"image/webp"}),x.jsx(Kh,{src:"/images/logo-optimized.png",alt:"PN",width:80,height:80,loading:"eager",decoding:"async",variants:Ph,initial:"initial",animate:"animate"})]}),x.jsx(Jh,{initial:{opacity:0},animate:{opacity:1},transition:{delay:.8,duration:.5}})]})})]})},ag=O.canvas`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,Md=[{r:42,g:157,b:143},{r:59,g:180,b:177},{r:67,g:97,b:165},{r:123,g:167,b:217}],lg=()=>{const S=nt.useRef(null),B=nt.useRef([]),V=nt.useRef(0),g=nt.useRef({x:window.innerWidth/2,y:window.innerHeight/2});return nt.useEffect(()=>{const D=S.current;if(!D)return;const q=D.getContext("2d");if(!q)return;const it=()=>{const T=window.devicePixelRatio||1;D.width=window.innerWidth*T,D.height=window.innerHeight*T,D.style.width=`${window.innerWidth}px`,D.style.height=`${window.innerHeight}px`,q.scale(T,T)};it(),window.addEventListener("resize",it);const G=4;B.current=[];for(let T=0;T<G;T++)B.current.push({x:window.innerWidth/2,y:window.innerHeight/2,size:60+T*20,color:Md[T%Md.length],speed:.1-T*.015,offset:T*.4});let L=0;const w=()=>{L+=.016,q.clearRect(0,0,D.width,D.height);const T=B.current,W=g.current;for(let Bt=T.length-1;Bt>=0;Bt--){const k=T[Bt],qt=Math.sin(L*1.5+k.offset*4)*15,Ja=Math.cos(L*1.5+k.offset*4)*15;k.x+=(W.x+qt-k.x)*k.speed,k.y+=(W.y+Ja-k.y)*k.speed;const Ea=k.size+Math.sin(L*1.2+k.offset*2)*8,ma=q.createRadialGradient(k.x,k.y,0,k.x,k.y,Ea),{r:Mt,g:Lt,b:aa}=k.color;ma.addColorStop(0,`rgba(${Mt}, ${Lt}, ${aa}, 0.25)`),ma.addColorStop(.4,`rgba(${Mt}, ${Lt}, ${aa}, 0.1)`),ma.addColorStop(.7,`rgba(${Mt}, ${Lt}, ${aa}, 0.03)`),ma.addColorStop(1,`rgba(${Mt}, ${Lt}, ${aa}, 0)`),q.beginPath(),q.arc(k.x,k.y,Ea,0,Math.PI*2),q.fillStyle=ma,q.fill()}V.current=requestAnimationFrame(w)},dt=T=>{g.current={x:T.clientX,y:T.clientY}};return window.addEventListener("mousemove",dt),V.current=requestAnimationFrame(w),()=>{window.removeEventListener("resize",it),window.removeEventListener("mousemove",dt),cancelAnimationFrame(V.current)}},[]),x.jsx(ag,{ref:S})},eg=Ta`
  0% {
