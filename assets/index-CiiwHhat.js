import{r as O,j as s,m as v,L as vg,A as Hi,u as Cf,a as yg,b as Mf,c as kf,d as xe}from"./vendor-motion-NN0UiyF0.js";import{r as xg,a as Sg}from"./vendor-react-DlBnNAMw.js";import{f as wg,m as Wt,d as p,l as st}from"./vendor-styled-TQ_oEx1d.js";(function(){const T=document.createElement("link").relList;if(T&&T.supports&&T.supports("modulepreload"))return;for(const j of document.querySelectorAll('link[rel="modulepreload"]'))d(j);new MutationObserver(j=>{for(const D of j)if(D.type==="childList")for(const B of D.addedNodes)B.tagName==="LINK"&&B.rel==="modulepreload"&&d(B)}).observe(document,{childList:!0,subtree:!0});function E(j){const D={};return j.integrity&&(D.integrity=j.integrity),j.referrerPolicy&&(D.referrerPolicy=j.referrerPolicy),j.crossOrigin==="use-credentials"?D.credentials="include":j.crossOrigin==="anonymous"?D.credentials="omit":D.credentials="same-origin",D}function d(j){if(j.ep)return;j.ep=!0;const D=E(j);fetch(j.href,D)}})();var ys={exports:{}},Dn={},xs={exports:{}},Ss={};var Hf;function zg(){return Hf||(Hf=1,(function(u){function T(z,M){var R=z.length;z.push(M);t:for(;0<R;){var ft=R-1>>>1,pt=z[ft];if(0<j(pt,M))z[ft]=M,z[R]=pt,R=ft;else break t}}function E(z){return z.length===0?null:z[0]}function d(z){if(z.length===0)return null;var M=z[0],R=z.pop();if(R!==M){z[0]=R;t:for(var ft=0,pt=z.length,Lt=pt>>>1;ft<Lt;){var vt=2*(ft+1)-1,tt=z[vt],Mt=vt+1,je=z[Mt];if(0>j(tt,R))Mt<pt&&0>j(je,tt)?(z[ft]=je,z[Mt]=R,ft=Mt):(z[ft]=tt,z[vt]=R,ft=vt);else if(Mt<pt&&0>j(je,R))z[ft]=je,z[Mt]=R,ft=Mt;else break t}}return M}function j(z,M){var R=z.sortIndex-M.sortIndex;return R!==0?R:z.id-M.id}if(u.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var D=performance;u.unstable_now=function(){return D.now()}}else{var B=Date,F=B.now();u.unstable_now=function(){return B.now()-F}}var G=[],K=[],$=1,C=null,P=3,qt=!1,L=!1,Ct=!1,Se=!1,bt=typeof setTimeout=="function"?setTimeout:null,rt=typeof clearTimeout=="function"?clearTimeout:null,dt=typeof setImmediate<"u"?setImmediate:null;function jt(z){for(var M=E(K);M!==null;){if(M.callback===null)d(K);else if(M.startTime<=z)d(K),M.sortIndex=M.expirationTime,T(G,M);else break;M=E(K)}}function Bt(z){if(Ct=!1,jt(z),!L)if(E(G)!==null)L=!0,se||(se=!0,ue());else{var M=E(K);M!==null&&He(Bt,M.startTime-z)}}var se=!1,we=-1,ze=5,Va=-1;function Cn(){return Se?!0:!(u.unstable_now()-Va<ze)}function $a(){if(Se=!1,se){var z=u.unstable_now();Va=z;var M=!0;try{t:{L=!1,Ct&&(Ct=!1,rt(we),we=-1),qt=!0;var R=P;try{e:{for(jt(z),C=E(G);C!==null&&!(C.expirationTime>z&&Cn());){var ft=C.callback;if(typeof ft=="function"){C.callback=null,P=C.priorityLevel;var pt=ft(C.expirationTime<=z);if(z=u.unstable_now(),typeof pt=="function"){C.callback=pt,jt(z),M=!0;break e}C===E(G)&&d(G),jt(z)}else d(G);C=E(G)}if(C!==null)M=!0;else{var Lt=E(K);Lt!==null&&He(Bt,Lt.startTime-z),M=!1}}break t}finally{C=null,P=R,qt=!1}M=void 0}}finally{M?ue():se=!1}}}var ue;if(typeof dt=="function")ue=function(){dt($a)};else if(typeof MessageChannel<"u"){var Mn=new MessageChannel,Bi=Mn.port2;Mn.port1.onmessage=$a,ue=function(){Bi.postMessage(null)}}else ue=function(){bt($a,0)};function He(z,M){we=bt(function(){z(u.unstable_now())},M)}u.unstable_IdlePriority=5,u.unstable_ImmediatePriority=1,u.unstable_LowPriority=4,u.unstable_NormalPriority=3,u.unstable_Profiling=null,u.unstable_UserBlockingPriority=2,u.unstable_cancelCallback=function(z){z.callback=null},u.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ze=0<z?Math.floor(1e3/z):5},u.unstable_getCurrentPriorityLevel=function(){return P},u.unstable_next=function(z){switch(P){case 1:case 2:case 3:var M=3;break;default:M=P}var R=P;P=M;try{return z()}finally{P=R}},u.unstable_requestPaint=function(){Se=!0},u.unstable_runWithPriority=function(z,M){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var R=P;P=z;try{return M()}finally{P=R}},u.unstable_scheduleCallback=function(z,M,R){var ft=u.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?ft+R:ft):R=ft,z){case 1:var pt=-1;break;case 2:pt=250;break;case 5:pt=1073741823;break;case 4:pt=1e4;break;default:pt=5e3}return pt=R+pt,z={id:$++,callback:M,priorityLevel:z,startTime:R,expirationTime:pt,sortIndex:-1},R>ft?(z.sortIndex=R,T(K,z),E(G)===null&&z===E(K)&&(Ct?(rt(we),we=-1):Ct=!0,He(Bt,R-ft))):(z.sortIndex=pt,T(G,z),L||qt||(L=!0,se||(se=!0,ue()))),z},u.unstable_shouldYield=Cn,u.unstable_wrapCallback=function(z){var M=P;return function(){var R=P;P=M;try{return z.apply(this,arguments)}finally{P=R}}}})(Ss)),Ss}var Of;function Ag(){return Of||(Of=1,xs.exports=zg()),xs.exports}var Bf;function Tg(){if(Bf)return Dn;Bf=1;var u=Ag(),T=xg(),E=Sg();function d(t){var e="https://react.dev/errors/"+t;if(1<arguments.length){e+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)e+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+t+"; visit "+e+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function j(t){return!(!t||t.nodeType!==1&&t.nodeType!==9&&t.nodeType!==11)}function D(t){var e=t,a=t;if(t.alternate)for(;e.return;)e=e.return;else{t=e;do e=t,(e.flags&4098)!==0&&(a=e.return),t=e.return;while(t)}return e.tag===3?a:null}function B(t){if(t.tag===13){var e=t.memoizedState;if(e===null&&(t=t.alternate,t!==null&&(e=t.memoizedState)),e!==null)return e.dehydrated}return null}function F(t){if(t.tag===31){var e=t.memoizedState;if(e===null&&(t=t.alternate,t!==null&&(e=t.memoizedState)),e!==null)return e.dehydrated}return null}function G(t){if(D(t)!==t)throw Error(d(188))}function K(t){var e=t.alternate;if(!e){if(e=D(t),e===null)throw Error(d(188));return e!==t?null:t}for(var a=t,i=e;;){var n=a.return;if(n===null)break;var l=n.alternate;if(l===null){if(i=n.return,i!==null){a=i;continue}break}if(n.child===l.child){for(l=n.child;l;){if(l===a)return G(n),t;if(l===i)return G(n),e;l=l.sibling}throw Error(d(188))}if(a.return!==i.return)a=n,i=l;else{for(var r=!1,o=n.child;o;){if(o===a){r=!0,a=n,i=l;break}if(o===i){r=!0,i=n,a=l;break}o=o.sibling}if(!r){for(o=l.child;o;){if(o===a){r=!0,a=l,i=n;break}if(o===i){r=!0,i=l,a=n;break}o=o.sibling}if(!r)throw Error(d(189))}}if(a.alternate!==i)throw Error(d(190))}if(a.tag!==3)throw Error(d(188));return a.stateNode.current===a?t:e}function $(t){var e=t.tag;if(e===5||e===26||e===27||e===6)return t;for(t=t.child;t!==null;){if(e=$(t),e!==null)return e;t=t.sibling}return null}var C=Object.assign,P=Symbol.for("react.element"),qt=Symbol.for("react.transitional.element"),L=Symbol.for("react.portal"),Ct=Symbol.for("react.fragment"),Se=Symbol.for("react.strict_mode"),bt=Symbol.for("react.profiler"),rt=Symbol.for("react.consumer"),dt=Symbol.for("react.context"),jt=Symbol.for("react.forward_ref"),Bt=Symbol.for("react.suspense"),se=Symbol.for("react.suspense_list"),we=Symbol.for("react.memo"),ze=Symbol.for("react.lazy"),Va=Symbol.for("react.activity"),Cn=Symbol.for("react.memo_cache_sentinel"),$a=Symbol.iterator;function ue(t){return t===null||typeof t!="object"?null:(t=$a&&t[$a]||t["@@iterator"],typeof t=="function"?t:null)}var Mn=Symbol.for("react.client.reference");function Bi(t){if(t==null)return null;if(typeof t=="function")return t.$$typeof===Mn?null:t.displayName||t.name||null;if(typeof t=="string")return t;switch(t){case Ct:return"Fragment";case bt:return"Profiler";case Se:return"StrictMode";case Bt:return"Suspense";case se:return"SuspenseList";case Va:return"Activity"}if(typeof t=="object")switch(t.$$typeof){case L:return"Portal";case dt:return t.displayName||"Context";case rt:return(t._context.displayName||"Context")+".Consumer";case jt:var e=t.render;return t=t.displayName,t||(t=e.displayName||e.name||"",t=t!==""?"ForwardRef("+t+")":"ForwardRef"),t;case we:return e=t.displayName||null,e!==null?e:Bi(t.type)||"Memo";case ze:e=t._payload,t=t._init;try{return Bi(t(e))}catch{}}return null}var He=Array.isArray,z=T.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,M=E.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,R={pending:!1,data:null,method:null,action:null},ft=[],pt=-1;function Lt(t){return{current:t}}function vt(t){0>pt||(t.current=ft[pt],ft[pt]=null,pt--)}function tt(t,e){pt++,ft[pt]=t.current,t.current=e}var Mt=Lt(null),je=Lt(null),Pe=Lt(null),kn=Lt(null);function Hn(t,e){switch(tt(Pe,e),tt(je,t),tt(Mt,null),e.nodeType){case 9:case 11:t=(t=e.documentElement)&&(t=t.namespaceURI)?Fd(t):0;break;default:if(t=e.tagName,e=e.namespaceURI)e=Fd(e),t=Id(e,t);else switch(t){case"svg":t=1;break;case"math":t=2;break;default:t=0}}vt(Mt),tt(Mt,t)}function Za(){vt(Mt),vt(je),vt(Pe)}function Pl(t){t.memoizedState!==null&&tt(kn,t);var e=Mt.current,a=Id(e,t.type);e!==a&&(tt(je,t),tt(Mt,a))}function On(t){je.current===t&&(vt(Mt),vt(je)),kn.current===t&&(vt(kn),An._currentValue=R)}var tr,js;function Ea(t){if(tr===void 0)try{throw Error()}catch(a){var e=a.stack.trim().match(/\n( *(at )?)/);tr=e&&e[1]||"",js=-1<a.stack.indexOf(`
...
`,Xf=O.createContext(void 0),As="portfolio-theme-mode",Mg=()=>{if(typeof window<"u"){const u=localStorage.getItem(As),T=window.matchMedia("(prefers-color-scheme: dark)").matches;return u==="dark"||u==="light"?u:T?"dark":"light"}return"dark"},kg=({children:u})=>{const[T,E]=O.useState(Mg),[d,j]=O.useState(()=>{if(typeof window<"u"){const B=localStorage.getItem(As);return B==="dark"||B==="light"}return!1});O.useEffect(()=>{document.documentElement.setAttribute("data-theme",T),requestAnimationFrame(()=>{document.body.classList.remove("no-transition")})},[T]),O.useEffect(()=>{document.body.classList.add("no-transition");const B=requestAnimationFrame(()=>{requestAnimationFrame(()=>{document.body.classList.remove("no-transition")})});return()=>cancelAnimationFrame(B)},[]),O.useEffect(()=>{d&&localStorage.setItem(As,T)},[T,d]);const D=()=>{j(!0),E(B=>B==="dark"?"light":"dark")};return s.jsx(Xf.Provider,{value:{mode:T,toggleTheme:D,isDark:T==="dark"},children:u})},oe=Wt`
...
`,Om={initial:{opacity:1},animate:{opacity:1},exit:{opacity:0,transition:{duration:.2,ease:"easeOut"}}},Bm={initial:{opacity:0,scale:1.5},animate:{opacity:1,scale:1,transition:{duration:1.5}},exit:{opacity:0,scale:.95,transition:{duration:.2}}},Um={initial:{},animate:{},exit:{scale:.9,opacity:0,transition:{duration:.2,ease:"easeOut"}}},Nm={initial:{opacity:0,scale:.5},animate:{opacity:1,scale:1,transition:{duration:.8,ease:[.25,.1,.25,1]}}},Rm={initial:{opacity:0,scale:0,rotate:-180},animate:{opacity:1,scale:1,rotate:0,transition:{type:"spring",stiffness:100,damping:15,delay:.2}}},Gm={initial:{opacity:0,scale:.3,rotateY:-90,filter:"blur(10px)"},animate:{opacity:1,scale:1,rotateY:0,filter:"blur(0px)",transition:{type:"spring",stiffness:80,damping:12,delay:.4}}};function _m(u){return()=>(u=(u*9301+49297)%233280,u/233280)}function qm(u,T){const E=_m(T),d=["rgba(42, 157, 143, 0.4)","rgba(59, 180, 177, 0.3)","rgba(67, 97, 165, 0.3)"];return Array.from({length:u},(j,D)=>({id:D,x:E()*100,y:E()*100,size:E()*4+2,color:d[D%3],duration:E()*3+2,delay:E()*2,repeatDelay:E()*2}))}const Lm=({onComplete:u})=>{const[T,E]=O.useState("animate"),d=O.useMemo(()=>qm(20,42),[]);return O.useEffect(()=>{const j=setTimeout(()=>{E("exit")},2200);return()=>clearTimeout(j)},[]),O.useEffect(()=>{T==="exit"&&u()},[T,u]),s.jsxs(zm,{variants:Om,initial:"initial",animate:T,children:[s.jsx(Am,{variants:Bm,initial:"initial",animate:T}),s.jsx(Tm,{initial:{opacity:1},animate:{opacity:T==="exit"?0:1},transition:{duration:.2},children:d.map(j=>s.jsx(Em,{$size:j.size,$color:j.color,style:{left:`${j.x}%`,top:`${j.y}%`},initial:{opacity:0,scale:0},animate:{opacity:[0,.8,0],scale:[0,1,0],y:[0,-100]},transition:{duration:j.duration,delay:j.delay,repeat:1/0,repeatDelay:j.repeatDelay}},j.id))}),s.jsx(jm,{variants:Um,initial:"initial",animate:T,children:s.jsxs(Dm,{children:[s.jsx(Cm,{variants:Nm,initial:"initial",animate:"animate"}),s.jsx(zs,{}),s.jsx(zs,{}),s.jsx(zs,{}),s.jsx(Mm,{variants:Rm,initial:"initial",animate:"animate"}),s.jsxs("picture",{children:[s.jsx("source",{srcSet:"/images/logo-optimized.webp",type:"image/webp"}),s.jsx(km,{src:"/images/logo-optimized.png",alt:"PN",width:80,height:80,loading:"eager",decoding:"async",variants:Gm,initial:"initial",animate:"animate"})]}),s.jsx(Hm,{initial:{opacity:0},animate:{opacity:1},transition:{delay:.8,duration:.5}})]})})]})},Ym=p.canvas`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,Rf=[{r:42,g:157,b:143},{r:59,g:180,b:177},{r:67,g:97,b:165},{r:123,g:167,b:217}],Qm=()=>{const u=O.useRef(null),T=O.useRef([]),E=O.useRef(0),d=O.useRef({x:window.innerWidth/2,y:window.innerHeight/2});return O.useEffect(()=>{const j=u.current;if(!j)return;const D=j.getContext("2d");if(!D)return;const B=()=>{const C=window.devicePixelRatio||1;j.width=window.innerWidth*C,j.height=window.innerHeight*C,j.style.width=`${window.innerWidth}px`,j.style.height=`${window.innerHeight}px`,D.scale(C,C)};B(),window.addEventListener("resize",B);const F=4;T.current=[];for(let C=0;C<F;C++)T.current.push({x:window.innerWidth/2,y:window.innerHeight/2,size:60+C*20,color:Rf[C%Rf.length],speed:.1-C*.015,offset:C*.4});let G=0;const K=()=>{G+=.016,D.clearRect(0,0,j.width,j.height);const C=T.current,P=d.current;for(let qt=C.length-1;qt>=0;qt--){const L=C[qt],Ct=Math.sin(G*1.5+L.offset*4)*15,Se=Math.cos(G*1.5+L.offset*4)*15;L.x+=(P.x+Ct-L.x)*L.speed,L.y+=(P.y+Se-L.y)*L.speed;const bt=L.size+Math.sin(G*1.2+L.offset*2)*8,rt=D.createRadialGradient(L.x,L.y,0,L.x,L.y,bt),{r:dt,g:jt,b:Bt}=L.color;rt.addColorStop(0,`rgba(${dt}, ${jt}, ${Bt}, 0.25)`),rt.addColorStop(.4,`rgba(${dt}, ${jt}, ${Bt}, 0.1)`),rt.addColorStop(.7,`rgba(${dt}, ${jt}, ${Bt}, 0.03)`),rt.addColorStop(1,`rgba(${dt}, ${jt}, ${Bt}, 0)`),D.beginPath(),D.arc(L.x,L.y,bt,0,Math.PI*2),D.fillStyle=rt,D.fill()}E.current=requestAnimationFrame(K)},$=C=>{d.current={x:C.clientX,y:C.clientY}};return window.addEventListener("mousemove",$),E.current=requestAnimationFrame(K),()=>{window.removeEventListener("resize",B),window.removeEventListener("mousemove",$),cancelAnimationFrame(E.current)}},[]),s.jsx(Ym,{ref:u})},Xm=p(v.div)`
  position: fixed;
  top: 0;
  left: 0;
  width: 10px;
...
`,Vm=()=>{const[u,T]=O.useState(!1),[E,d]=O.useState(!1),j=Cf(0),D=Cf(0),B=O.useCallback($=>{j.set($.clientX),D.set($.clientY),u||T(!0)},[j,D,u]),F=O.useCallback(()=>{T(!0)},[]),G=O.useCallback(()=>{T(!1)},[]),K=O.useCallback($=>{const C=$.target;if(C.closest("nav")!==null){d(!1);return}if(C.tagName==="A"||C.closest("a")!==null){d(!0);return}const L=C.tagName==="INPUT"||C.tagName==="TEXTAREA",Ct=C.contentEditable==="true",bt=["P","SPAN","H1","H2","H3","H4","H5","H6","LI","TD","TH","LABEL","BLOCKQUOTE","PRE","CODE","EM","STRONG","B","I","U"].includes(C.tagName),rt=Array.from(C.childNodes).some(jt=>jt.nodeType===Node.TEXT_NODE&&jt.textContent?.trim());d(L||Ct||bt&&rt)},[]);return O.useEffect(()=>{if("ontouchstart"in window||navigator.maxTouchPoints>0)return;document.addEventListener("mousemove",B),document.addEventListener("mouseenter",F),document.addEventListener("mouseleave",G),document.addEventListener("mouseover",K);const C=document.createElement("style");return C.id="custom-cursor-styles",C.textContent=`
      *, *::before, *::after {
        cursor: none !important;
      }
    ...
    `,document.head.appendChild(C),()=>{document.removeEventListener("mousemove",B),document.removeEventListener("mouseenter",F),document.removeEventListener("mouseleave",G),document.removeEventListener("mouseover",K);const P=document.getElementById("custom-cursor-styles");P&&P.remove()}},[B,F,G,K]),typeof window<"u"&&("ontouchstart"in window||navigator.maxTouchPoints>0)?null:s.jsx(Xm,{style:{x:j,y:D,translateX:"-50%",translateY:"-50%"},animate:{opacity:u&&!E?1:0,scale:u&&!E?1:0},transition:{duration:.15}})},$m=p.section`
  min-height: 100vh;
  display: flex;
  align-items: center;
...
`;function vh(u){const T=O.useCallback(j=>{const D=window.matchMedia(u);return D.addEventListener("change",j),()=>D.removeEventListener("change",j)},[u]),E=O.useCallback(()=>window.matchMedia(u).matches,[u]),d=O.useCallback(()=>!1,[]);return O.useSyncExternalStore(T,E,d)}function yh(u=1024){return vh(`(max-width: ${u}px)`)}function xh(){const u=O.useRef(null),T=yh(1024),{scrollYProgress:E}=yg(),d=Mf(E,[0,.3],["0%","30%"]),j=Mf(E,[0,.15],T?[.9,1]:[1,.95]),D=kf(d,{stiffness:100,damping:30}),B=kf(j,{stiffness:100,damping:30});return{containerRef:u,backgroundY:D,imageScale:B}}p.section`
  padding: 64px 24px;
...
`,Pb=p.span`
  color: var(--text-secondary);
`,tv=({data:u})=>{const[T,E]=O.useState(new Set),d=O.useRef(null),j=xe(d,{once:!0,margin:"-100px"}),D=B=>{E(F=>{const G=new Set(F);return G.has(B)?G.delete(B):G.add(B),G})};return s.jsx(Mb,{id:"professionalexperience",ref:d,children:s.jsxs(kb,{children:[s.jsx(Ta,{number:"03",title:"Experience",inView:j}),s.jsx(Hb,{children:u.timeline.map((B,F)=>{const G=T.has(F);return s.jsxs(Ob,{initial:{opacity:0,x:-30,filter:"blur(4px)"},whileInView:{opacity:1,x:0,filter:"blur(0px)"},viewport:{once:!0,margin:"-50px"},transition:{type:"spring",stiffness:100,damping:20,delay:.1},children:[s.jsx(Bb,{children:s.jsx(Ub,{children:B.date})}),s.jsxs(Nb,{children:[s.jsxs(Rb,{children:[s.jsx(Gb,{children:s.jsx("a",{href:B.url,target:"_blank",rel:"noopener noreferrer",children:B.title})}),s.jsx(Yb,{children:B.subTitle}),B.previously&&s.jsxs(Qb,{initial:{opacity:0,y:5},animate:{opacity:1,y:0},transition:{delay:.1},children:[s.jsx(Xb,{children:"Previously:"}),s.jsx(Vb,{children:B.previously})]})]}),s.jsx($b,{dangerouslySetInnerHTML:{__html:B.descriptionSummary}}),s.jsx(_b,{$isOpen:G,whileHover:{scale:1.02},whileTap:{scale:.98},transition:{type:"spring",stiffness:400,damping:25},onClick:()=>D(F),"aria-expanded":G,"aria-label":G?"Show less":"Show more",children:s.jsxs(qb,{$isOpen:G,children:["Show ",s.jsx(Hi,{mode:"wait",children:s.jsx(Lb,{initial:"hidden",animate:"visible",exit:"exit",children:(G?"Less":"More").split("").map((K,$)=>s.jsx(v.span,{variants:{hidden:{opacity:0},visible:{opacity:1,transition:{delay:$*.05}},exit:{opacity:0,transition:{delay:(3-$)*.03}}},children:K},$))},G?"less":"more")})]})}),s.jsx(Zb,{$isExpanded:G,children:s.jsx(Kb,{children:s.jsx(Jb,{$isExpanded:G,children:s.jsx(Wb,{$isExpanded:G,children:B.achievements?.map((K,$)=>s.jsxs(Fb,{$index:$,$isExpanded:G,children:[s.jsx(Ib,{children:K.title}),": ",s.jsx(Pb,{children:K.description})]},$))})})})})]})]},F)})})]})})},ev=p.section`
  padding: 64px 24px;
  overflow: hidden;
  background: var(--bg-primary);
  position: relative;
...
`,bv={enter:u=>({x:u>0?80:-80,opacity:0,scale:.98}),center:{x:0,opacity:1,scale:1,transition:{type:"spring",stiffness:500,damping:35,mass:.8}},exit:u=>({x:u<0?80:-80,opacity:0,scale:.98,transition:{type:"spring",stiffness:500,damping:35,mass:.8}})},vv={collapsed:{opacity:0},expanded:{opacity:1,transition:{duration:.25,ease:[.4,0,.2,1],delay:.1}}},yv={collapsed:{opacity:0,y:-6},expanded:{opacity:1,y:0,transition:{duration:.3,ease:[.4,0,.2,1]}}},xv={collapsed:{opacity:0},expanded:{opacity:1,transition:{staggerChildren:.025,delayChildren:.08}}},Sv={collapsed:{opacity:0,x:-8},expanded:{opacity:1,x:0,transition:{duration:.2,ease:[.4,0,.2,1]}}};function wv({totalItems:u,animationDuration:T=350,wheelThreshold:E=20,swipeThreshold:d=30,velocityThreshold:j=200}){const[[D,B],F]=O.useState([0,0]),[G,K]=O.useState(!1),[$,C]=O.useState(!1),P=O.useRef(null),qt=O.useRef(0),L=O.useCallback(bt=>{if($)return;const rt=D+bt;rt>=0&&rt<u&&(C(!0),F([rt,bt]),K(!1),setTimeout(()=>C(!1),T))},[D,u,$,T]),Ct=O.useCallback(bt=>{if($||bt===D)return;const rt=bt>D?1:-1;C(!0),F([bt,rt]),K(!1),setTimeout(()=>C(!1),T)},[D,$,T]);O.useEffect(()=>{const bt=P.current;if(!bt)return;const rt=dt=>{const jt=Date.now();if(jt-qt.current<300)return;const Bt=Math.abs(dt.deltaX)>Math.abs(dt.deltaY)?dt.deltaX:dt.deltaY;if(Math.abs(Bt)>E){const se=D<u-1,we=D>0;(Bt>0&&se||Bt<0&&we)&&(dt.preventDefault(),dt.stopPropagation(),qt.current=jt,Bt>0?L(1):L(-1))}};return bt.addEventListener("wheel",rt,{passive:!1}),()=>bt.removeEventListener("wheel",rt)},[D,u,L,E]);const Se=O.useCallback((bt,rt)=>{$||(rt.velocity.x>j||rt.offset.x>d?D>0&&L(-1):(rt.velocity.x<-j||rt.offset.x<-d)&&D<u-1&&L(1))},[D,u,$,L,d,j]);return{activeIndex:D,direction:B,isAnimating:$,cardRef:P,paginate:L,goToSlide:Ct,handleDragEnd:Se,setIsExpanded:K,isExpanded:G}}const zv=({title:u,content:T,isExpanded:E,onToggle:d})=>s.jsxs(s.Fragment,{children:[s.jsxs(rv,{$isExpanded:E,onClick:d,whileHover:{scale:1.01},transition:{type:"spring",stiffness:400,damping:25},children:[s.jsx(ov,{children:u}),s.jsx(sv,{$isExpanded:E,"aria-label":E?"Collapse project details":"Expand project details","aria-expanded":E,animate:{rotate:E?45:0,scale:E?1.1:1},transition:{type:"spring",stiffness:400,damping:20},whileHover:{scale:1.15},whileTap:{scale:.95},children:s.jsx(v.svg,{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2","aria-hidden":"true",children:s.jsx("path",{d:"M12 5v14M5 12h14"})})})]}),s.jsx(uv,{$isExpanded:E,children:s.jsx(cv,{initial:"collapsed",animate:E?"expanded":"collapsed",variants:vv,children:s.jsx(dv,{initial:"collapsed",animate:E?"expanded":"collapsed",variants:yv,children:s.jsx(fv,{variants:xv,initial:"collapsed",animate:E?"expanded":"collapsed",children:T.map((j,D)=>s.jsx(pv,{variants:Sv,children:j},D))})})})})]}),Av=()=>s.jsx("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2","aria-hidden":"true",children:s.jsx("path",{d:"M19 12H5M12 19l-7-7 7-7"})}),Tv=()=>s.jsx("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2","aria-hidden":"true",children:s.jsx("path",{d:"M5 12h14M12 5l7 7-7 7"})}),Ev=({activeIndex:u,totalItems:T,isInView:E,onPaginate:d,onGoToSlide:j,projectTitles:D})=>s.jsxs(gv,{initial:{opacity:0,y:20},animate:E?{opacity:1,y:0}:{},transition:{type:"spring",stiffness:100,damping:20,delay:.4},children:[s.jsx(Yf,{onClick:()=>d(-1),disabled:u===0,"aria-label":"Previous project",whileHover:{scale:1.1},whileTap:{scale:.95},transition:{type:"spring",stiffness:400,damping:25},children:s.jsx(Av,{})}),s.jsx(mv,{role:"tablist","aria-label":"Project navigation",children:D.map((B,F)=>s.jsx(hv,{$isActive:u===F,onClick:()=>j(F),role:"tab","aria-selected":u===F,"aria-label":`Go to project ${F+1}: ${B}`,whileHover:{scale:1.1},whileTap:{scale:.95},animate:{width:u===F?36:12},transition:{type:"spring",stiffness:400,damping:25}},F))}),s.jsx(Yf,{onClick:()=>d(1),disabled:u===T-1,"aria-label":"Next project",whileHover:{scale:1.1},whileTap:{scale:.95},transition:{type:"spring",stiffness:400,damping:25},children:s.jsx(Tv,{})})]}),jv=({data:u})=>{const T=O.useRef(null),E=xe(T,{once:!0,margin:"-100px"}),{activeIndex:d,direction:j,cardRef:D,paginate:B,goToSlide:F,handleDragEnd:G,isExpanded:K,setIsExpanded:$}=wv({totalItems:u.content.length}),C=u.content[d];return s.jsx(ev,{id:"mostproudof",ref:T,children:s.jsxs(av,{children:[s.jsx(Ta,{number:"04",title:"Projects",inView:E}),s.jsxs(iv,{initial:{opacity:0,y:40},animate:E?{opacity:1,y:0}:{},transition:{type:"spring",stiffness:80,damping:20,delay:.2},children:[s.jsx(nv,{ref:D,children:s.jsx(Hi,{initial:!1,custom:j,mode:"wait",children:s.jsx(lv,{custom:j,variants:bv,initial:"enter",animate:"center",exit:"exit",drag:"x",dragConstraints:{left:0,right:0},dragElastic:.1,dragMomentum:!1,onDragEnd:G,transition:{x:{type:"spring",stiffness:500,damping:35,mass:.8},opacity:{duration:.2},scale:{type:"spring",stiffness:500,damping:35,mass:.8}},style:{cursor:"grab",touchAction:"pan-y"},whileDrag:{cursor:"grabbing",scale:1.01},children:s.jsx(zv,{title:C.title,content:C.content,isExpanded:K,onToggle:()=>$(!K)})},d)})}),s.jsx(Ev,{activeIndex:d,totalItems:u.content.length,isInView:E,onPaginate:B,onGoToSlide:F,projectTitles:u.content.map(P=>P.title)})]})]})})},Dv=p.section`
  padding: 64px 24px;
  background: var(--bg-secondary);
  position: relative;
  overflow: hidden;
...
`,Nv=({data:u})=>{const T=O.useRef(null),E=xe(T,{once:!0,margin:"-100px"}),d=j=>j.toLowerCase().includes("azure")||j.toLowerCase().includes("microsoft")?"Microsoft":j.toLowerCase().includes("aws")?"Amazon Web Services":"";return s.jsx(Dv,{id:"certifications",ref:T,children:s.jsxs(Cv,{children:[s.jsx(Ta,{number:"05",title:"Certifications",inView:E}),s.jsx(Mv,{children:u.certificateProps.certificateMetaData.map((j,D)=>s.jsxs(kv,{initial:{opacity:0,x:-30,filter:"blur(4px)"},whileInView:{opacity:1,x:0,filter:"blur(0px)"},viewport:{once:!0,margin:"-50px"},transition:{type:"spring",stiffness:100,damping:20,delay:D*.08},whileHover:{x:12,transition:{type:"spring",stiffness:400,damping:25}},children:[s.jsxs(Hv,{children:[s.jsx(Ov,{children:j.title}),s.jsx(Bv,{children:d(j.title)})]}),s.jsxs(Uv,{href:j.buttonProps.link,target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.05},whileTap:{scale:.98},transition:{type:"spring",stiffness:400,damping:25},children:[s.jsx("span",{children:"Verify"}),s.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[s.jsx("path",{d:"M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6"}),s.jsx("polyline",{points:"15,3 21,3 21,9"}),s.jsx("line",{x1:"10",y1:"14",x2:"21",y2:"3"})]})]})]},D))})]})})},Rv=p.section`
  padding: 64px 24px;
  background: var(--bg-primary);
  position: relative;
  overflow: hidden;
...
`,Vv=p(v.span)`
  ...
  color: var(--text-tertiary);
  transition: color var(--timing-medium) var(--ease-standard);
`,$v=({data:u})=>{const T=O.useRef(null),E=xe(T,{once:!0,margin:"-100px"});return s.jsx(Rv,{id:"testimonials",ref:T,children:s.jsxs(Gv,{children:[s.jsx(Ta,{number:"06",title:"Testimonials",inView:E}),s.jsx(_v,{children:u.quoteProps.quoteMetaData.map((d,j)=>s.jsxs(qv,{initial:{opacity:0,y:40,filter:"blur(4px)"},whileInView:{opacity:1,y:0,filter:"blur(0px)"},viewport:{once:!0,margin:"-50px"},transition:{type:"spring",stiffness:100,damping:20,delay:j*.1},whileHover:{y:-8,scale:1.02,transition:{type:"spring",stiffness:300,damping:20}},children:[s.jsx(Lv,{children:'"'}),s.jsx(Yv,{children:d.quote}),s.jsxs(Qv,{children:[s.jsx(Xv,{children:d.givenBy}),s.jsx(Vv,{children:d.subTitleGivenBy})]})]},j))})]})})},Zv=p.section`
  padding: 64px 24px;
  background: var(--bg-secondary);
  position: relative;
  overflow: hidden;
