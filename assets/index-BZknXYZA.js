...
`,TE={hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.08,delayChildren:.05}}},AE={hidden:{opacity:0,scale:.8,filter:"blur(4px)"},visible:{opacity:1,scale:1,filter:"blur(0px)",transition:{type:"spring",stiffness:200,damping:20}}},wE={hidden:{opacity:0,x:-10},visible:{opacity:1,x:0,transition:{type:"spring",stiffness:150,damping:20}}},EE={hidden:{opacity:0,y:20,filter:"blur(8px)"},visible:{opacity:1,y:0,filter:"blur(0px)",transition:{type:"spring",stiffness:100,damping:18}}},CE={hidden:{scaleX:0,opacity:0},visible:{scaleX:1,opacity:1,transition:{duration:.6,ease:[.25,.1,.25,1],delay:.3}}},ME={About:"Who I Am",Skills:"Technical Expertise",Experience:"Career Journey",Projects:"Featured Work",Certifications:"Credentials",Testimonials:"What Others Say",Education:"Academic Background",Contact:"Get In Touch"},xi=({number:n,title:a,inView:r=!0})=>{const o=ME[a]||"Section";return x.jsxs(pE,{variants:TE,initial:"hidden",animate:r?"visible":"hidden",children:[x.jsxs(mE,{children:[x.jsx(gE,{variants:AE,children:x.jsx(yE,{children:n})}),x.jsxs(vE,{children:[x.jsx(bE,{variants:wE,children:o}),x.jsx(xE,{variants:EE,children:a})]})]}),x.jsx(SE,{variants:CE})]})};C.section`
  padding: 64px 24px;
