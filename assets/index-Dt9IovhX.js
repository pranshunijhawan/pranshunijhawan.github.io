import{r as Y,j as o,m as v,A as Ml,u as dg,a as go,b as zd,c as we}from"./vendor-motion-BoSVoJ0s.js";import{r as pg,a as gg}from"./vendor-react-DlBnNAMw.js";import{f as mg,m as qt,d,l as vo}from"./vendor-styled-Du6AN5G6.js";(function(){const j=document.createElement("link").relList;if(j&&j.supports&&j.supports("modulepreload"))return;for(const T of document.querySelectorAll('link[rel="modulepreload"]'))p(T);new MutationObserver(T=>{for(const H of T)if(H.type==="childList")for(const E of H.addedNodes)E.tagName==="LINK"&&E.rel==="modulepreload"&&p(E)}).observe(document,{childList:!0,subtree:!0});function N(T){const H={};return T.integrity&&(H.integrity=T.integrity),T.referrerPolicy&&(H.referrerPolicy=T.referrerPolicy),T.crossOrigin==="use-credentials"?H.credentials="include":T.crossOrigin==="anonymous"?H.credentials="omit":H.credentials="same-origin",H}function p(T){if(T.ep)return;T.ep=!0;const H=N(T);fetch(T.href,H)}})();var mo={exports:{}},wn={},ho={exports:{}},bo={};var wd;function hg(){return wd||(wd=1,(function(b){function j(z,M){var _=z.length;z.push(M);t:for(;0<_;){var ct=_-1>>>1,ot=z[ct];if(0<T(ot,M))z[ct]=M,z[_]=ot,_=ct;else break t}}function N(z){return z.length===0?null:z[0]}function p(z){if(z.length===0)return null;var M=z[0],_=z.pop();if(_!==M){z[0]=_;t:for(var ct=0,ot=z.length,Gt=ot>>>1;ct<Gt;){var gt=2*(ct+1)-1,tt=z[gt],Et=gt+1,Ae=z[Et];if(0>T(tt,_))Et<ot&&0>T(Ae,tt)?(z[ct]=Ae,z[Et]=_,ct=Et):(z[ct]=tt,z[gt]=_,ct=gt);else if(Et<ot&&0>T(Ae,_))z[ct]=Ae,z[Et]=_,ct=Et;else break t}}return M}function T(z,M){var _=z.sortIndex-M.sortIndex;return _!==0?_:z.id-M.id}if(b.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var H=performance;b.unstable_now=function(){return H.now()}}else{var E=Date,G=E.now();b.unstable_now=function(){return E.now()-G}}var k=[],V=[],xt=1,D=null,J=3,Yt=!1,I=!1,Ct=!1,ft=!1,$=typeof setTimeout=="function"?setTimeout:null,bt=typeof clearTimeout=="function"?clearTimeout:null,pt=typeof setImmediate<"u"?setImmediate:null;function jt(z){for(var M=N(V);M!==null;){if(M.callback===null)p(V);else if(M.startTime<=z)p(V),M.sortIndex=M.expirationTime,j(k,M);else break;M=N(V)}}function $t(z){if(Ct=!1,jt(z),!I)if(N(k)!==null)I=!0,ue||(ue=!0,ce());else{var M=N(V);M!==null&&De($t,M.startTime-z)}}var ue=!1,ye=-1,ve=5,Ya=-1;function An(){return ft?!0:!(b.unstable_now()-Ya<ve)}function Xa(){if(ft=!1,ue){var z=b.unstable_now();Ya=z;var M=!0;try{t:{I=!1,Ct&&(Ct=!1,bt(ye),ye=-1),Yt=!0;var _=J;try{e:{for(jt(z),D=N(k);D!==null&&!(D.expirationTime>z&&An());){var ct=D.callback;if(typeof ct=="function"){D.callback=null,J=D.priorityLevel;var ot=ct(D.expirationTime<=z);if(z=b.unstable_now(),typeof ot=="function"){D.callback=ot,jt(z),M=!0;break e}D===N(k)&&p(k),jt(z)}else p(k);D=N(k)}if(D!==null)M=!0;else{var Gt=N(V);Gt!==null&&De($t,Gt.startTime-z),M=!1}}break t}finally{D=null,J=_,Yt=!1}M=void 0}}finally{M?ce():ue=!1}}}var ce;if(typeof pt=="function")ce=function(){pt(Xa)};else if(typeof MessageChannel<"u"){var Tn=new MessageChannel,Dl=Tn.port2;Tn.port1.onmessage=Xa,ce=function(){Dl.postMessage(null)}}else ce=function(){$(Xa,0)};function De(z,M){ye=$(function(){z(b.unstable_now())},M)}b.unstable_IdlePriority=5,b.unstable_ImmediatePriority=1,b.unstable_LowPriority=4,b.unstable_NormalPriority=3,b.unstable_Profiling=null,b.unstable_UserBlockingPriority=2,b.unstable_cancelCallback=function(z){z.callback=null},b.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ve=0<z?Math.floor(1e3/z):5},b.unstable_getCurrentPriorityLevel=function(){return J},b.unstable_next=function(z){switch(J){case 1:case 2:case 3:var M=3;break;default:M=J}var _=J;J=M;try{return z()}finally{J=_}},b.unstable_requestPaint=function(){ft=!0},b.unstable_runWithPriority=function(z,M){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var _=J;J=z;try{return M()}finally{J=_}},b.unstable_scheduleCallback=function(z,M,_){var ct=b.unstable_now();switch(typeof _=="object"&&_!==null?(_=_.delay,_=typeof _=="number"&&0<_?ct+_:ct):_=ct,z){case 1:var ot=-1;break;case 2:ot=250;break;case 5:ot=1073741823;break;case 4:ot=1e4;break;default:ot=5e3}return ot=_+ot,z={id:xt++,callback:M,priorityLevel:z,startTime:_,expirationTime:ot,sortIndex:-1},_>ct?(z.sortIndex=_,j(V,z),N(k)===null&&z===N(V)&&(Ct?(bt(ye),ye=-1):Ct=!0,De($t,_-ct))):(z.sortIndex=ot,j(k,z),I||Yt||(I=!0,ue||(ue=!0,ce()))),z},b.unstable_shouldYield=An,b.unstable_wrapCallback=function(z){var M=J;return function(){var _=J;J=M;try{return z.apply(this,arguments)}finally{J=_}}}})(bo)),bo}var Ad;function bg(){return Ad||(Ad=1,ho.exports=hg()),ho.exports}var Td;function yg(){if(Td)return wn;Td=1;var b=bg(),j=pg(),N=gg();function p(t){var e="https://react.dev/errors/"+t;if(1<arguments.length){e+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)e+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+t+"; visit "+e+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function T(t){return!(!t||t.nodeType!==1&&t.nodeType!==9&&t.nodeType!==11)}function H(t){var e=t,a=t;if(t.alternate)for(;e.return;)e=e.return;else{t=e;do e=t,(e.flags&4098)!==0&&(a=e.return),t=e.return;while(t)}return e.tag===3?a:null}function E(t){if(t.tag===13){var e=t.memoizedState;if(e===null&&(t=t.alternate,t!==null&&(e=t.memoizedState)),e!==null)return e.dehydrated}return null}function G(t){if(t.tag===31){var e=t.memoizedState;if(e===null&&(t=t.alternate,t!==null&&(e=t.memoizedState)),e!==null)return e.dehydrated}return null}function k(t){if(H(t)!==t)throw Error(p(188))}function V(t){var e=t.alternate;if(!e){if(e=H(t),e===null)throw Error(p(188));return e!==t?null:t}for(var a=t,l=e;;){var n=a.return;if(n===null)break;var i=n.alternate;if(i===null){if(l=n.return,l!==null){a=l;continue}break}if(n.child===i.child){for(i=n.child;i;){if(i===a)return k(n),t;if(i===l)return k(n),e;i=i.sibling}throw Error(p(188))}if(a.return!==l.return)a=n,l=i;else{for(var u=!1,c=n.child;c;){if(c===a){u=!0,a=n,l=i;break}if(c===l){u=!0,l=n,a=i;break}c=c.sibling}if(!u){for(c=i.child;c;){if(c===a){u=!0,a=i,l=n;break}if(c===l){u=!0,l=i,a=n;break}c=c.sibling}if(!u)throw Error(p(189))}}if(a.alternate!==l)throw Error(p(190))}if(a.tag!==3)throw Error(p(188));return a.stateNode.current===a?t:e}function xt(t){var e=t.tag;if(e===5||e===26||e===27||e===6)return t;for(t=t.child;t!==null;){if(e=xt(t),e!==null)return e;t=t.sibling}return null}var D=Object.assign,J=Symbol.for("react.element"),Yt=Symbol.for("react.transitional.element"),I=Symbol.for("react.portal"),Ct=Symbol.for("react.fragment"),ft=Symbol.for("react.strict_mode"),$=Symbol.for("react.profiler"),bt=Symbol.for("react.consumer"),pt=Symbol.for("react.context"),jt=Symbol.for("react.forward_ref"),$t=Symbol.for("react.suspense"),ue=Symbol.for("react.suspense_list"),ye=Symbol.for("react.memo"),ve=Symbol.for("react.lazy"),Ya=Symbol.for("react.activity"),An=Symbol.for("react.memo_cache_sentinel"),Xa=Symbol.iterator;function ce(t){return t===null||typeof t!="object"?null:(t=Xa&&t[Xa]||t["@@iterator"],typeof t=="function"?t:null)}var Tn=Symbol.for("react.client.reference");function Dl(t){if(t==null)return null;if(typeof t=="function")return t.$$typeof===Tn?null:t.displayName||t.name||null;if(typeof t=="string")return t;switch(t){case Ct:return"Fragment";case $:return"Profiler";case ft:return"StrictMode";case $t:return"Suspense";case ue:return"SuspenseList";case Ya:return"Activity"}if(typeof t=="object")switch(t.$$typeof){case I:return"Portal";case pt:return t.displayName||"Context";case bt:return(t._context.displayName||"Context")+".Consumer";case jt:var e=t.render;return t=t.displayName,t||(t=e.displayName||e.name||"",t=t!==""?"ForwardRef("+t+")":"ForwardRef"),t;case ye:return e=t.displayName||null,e!==null?e:Dl(t.type)||"Memo";case ve:e=t._payload,t=t._init;try{return Dl(t(e))}catch{}}return null}var De=Array.isArray,z=j.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,M=N.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,_={pending:!1,data:null,method:null,action:null},ct=[],ot=-1;function Gt(t){return{current:t}}function gt(t){0>ot||(t.current=ct[ot],ct[ot]=null,ot--)}function tt(t,e){ot++,ct[ot]=t.current,t.current=e}var Et=Gt(null),Ae=Gt(null),$e=Gt(null),jn=Gt(null);function En(t,e){switch(tt($e,e),tt(Ae,t),tt(Et,null),e.nodeType){case 9:case 11:t=(t=e.documentElement)&&(t=t.namespaceURI)?Lf(t):0;break;default:if(t=e.tagName,e=e.namespaceURI)e=Lf(e),t=Zf(e,t);else switch(t){case"svg":t=1;break;case"math":t=2;break;default:t=0}}gt(Et),tt(Et,t)}function Qa(){gt(Et),gt(Ae),gt($e)}function Ji(t){t.memoizedState!==null&&tt(jn,t);var e=Et.current,a=Zf(e,t.type);e!==a&&(tt(Ae,t),tt(Et,a))}function Mn(t){Ae.current===t&&(gt(Et),gt(Ae)),jn.current===t&&(gt(jn),vn._currentValue=_)}var $i,xo;function za(t){if($i===void 0)try{throw Error()}catch(a){var e=a.stack.trim().match(/\n( *(at )?)/);$i=e&&e[1]||"",xo=-1<a.stack.indexOf(`
...
`,_d=Y.createContext(void 0),kd="portfolio-theme-mode",zg=()=>{if(typeof window<"u"){const b=localStorage.getItem(kd);if(b==="dark"||b==="light")return b}return"dark"},wg=({children:b})=>{const[j,N]=Y.useState(zg);Y.useEffect(()=>{document.documentElement.setAttribute("data-theme",j),localStorage.setItem(kd,j)},[j]);const p=()=>{N(T=>T==="dark"?"light":"dark")};return o.jsx(_d.Provider,{value:{mode:j,toggleTheme:p,isDark:j==="dark"},children:b})},Ag=()=>{const b=Y.useContext(_d);if(!b)throw new Error("useTheme must be used within a ThemeProvider");return b},qd=qt`
  0% {
...
`,Ed=[{label:"About",href:"#about"},{label:"Skills",href:"#technologyproficiency"},{label:"Experience",href:"#professionalexperience"},{label:"Projects",href:"#mostproudof"},{label:"Contact",href:"#contact"}],Ug=()=>{const[b,j]=Y.useState(""),{isDark:N,toggleTheme:p}=Ag();Y.useEffect(()=>{const E=()=>{const G=Ed.map(V=>V.href.replace("#",""));if(window.innerHeight+window.scrollY>=document.documentElement.scrollHeight-100){j(G[G.length-1]);return}for(const V of[...G].reverse()){const xt=document.getElementById(V);if(xt&&xt.getBoundingClientRect().top<=150){j(V);return}}j("")};return window.addEventListener("scroll",E,{passive:!0}),()=>window.removeEventListener("scroll",E)},[]);const T=E=>{const G=E.currentTarget.getBoundingClientRect(),k=(E.clientX-G.left)/G.width*100,V=(E.clientY-G.top)/G.height*100;E.currentTarget.style.setProperty("--mouse-x",`${k}%`),E.currentTarget.style.setProperty("--mouse-y",`${V}%`)},H=(E,G)=>{E.preventDefault();const k=document.getElementById(G);k&&k.scrollIntoView({behavior:"smooth",block:"start"})};return o.jsx(Tg,{children:o.jsxs(jg,{"aria-label":"Main navigation",initial:{opacity:0,y:-20,scale:.95},animate:{opacity:1,y:0,scale:1},transition:{duration:.6,ease:[.25,.1,.25,1],delay:.2},children:[o.jsx(Eg,{href:"#home",onClick:E=>H(E,"home"),whileHover:{scale:1.05},whileTap:{scale:.95},children:o.jsxs("picture",{children:[o.jsx("source",{srcSet:"/images/logo-100.webp",type:"image/webp"}),o.jsx(Mg,{src:"/images/logo-optimized.png",alt:"PN",width:28,height:28,loading:"eager",decoding:"async"})]})}),o.jsx(Dg,{children:Ed.map(E=>{const G=b===E.href.replace("#","");return o.jsxs(Cg,{href:E.href,$isActive:G,"aria-current":G?"page":void 0,onClick:k=>H(k,E.href.replace("#","")),onMouseMove:T,whileHover:{scale:1.02},whileTap:{scale:.98},children:[o.jsx(Ml,{children:G&&o.jsx(Og,{initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.8},transition:{duration:.15,ease:"easeOut"}},E.label)}),o.jsx("span",{style:{position:"relative",zIndex:1},children:E.label})]},E.label)})}),o.jsx(Hg,{onClick:p,whileHover:{scale:1.05},whileTap:{scale:.95},title:N?"Switch to light mode":"Switch to dark mode","aria-label":N?"Switch to light mode":"Switch to dark mode",role:"button",children:o.jsx(Ml,{mode:"wait",children:N?o.jsxs(v.svg,{viewBox:"0 0 24 24",fill:"none",strokeWidth:"2",initial:{rotate:-90,opacity:0},animate:{rotate:0,opacity:1},exit:{rotate:90,opacity:0},transition:{duration:.3},children:[o.jsx("defs",{children:o.jsxs("linearGradient",{id:"sunGradient",x1:"0%",y1:"0%",x2:"100%",y2:"100%",children:[o.jsx("stop",{offset:"0%",stopColor:"#2A9D8F"}),o.jsx("stop",{offset:"50%",stopColor:"#3BB4B1"}),o.jsx("stop",{offset:"100%",stopColor:"#4361A5"})]})}),o.jsx("circle",{cx:"12",cy:"12",r:"5",stroke:"url(#sunGradient)"}),o.jsx("path",{stroke:"url(#sunGradient)",d:"M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"})]},"sun"):o.jsxs(v.svg,{viewBox:"0 0 24 24",fill:"none",strokeWidth:"2",initial:{rotate:90,opacity:0},animate:{rotate:0,opacity:1},exit:{rotate:-90,opacity:0},transition:{duration:.3},children:[o.jsx("defs",{children:o.jsxs("linearGradient",{id:"moonGradient",x1:"0%",y1:"0%",x2:"100%",y2:"100%",children:[o.jsx("stop",{offset:"0%",stopColor:"#2A9D8F"}),o.jsx("stop",{offset:"50%",stopColor:"#3BB4B1"}),o.jsx("stop",{offset:"100%",stopColor:"#4361A5"})]})}),o.jsx("path",{stroke:"url(#moonGradient)",d:"M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"})]},"moon")})})]})})},Bg="2.0.2",Gd=qt`
  0% {
...
`,d1={collapsed:{height:0,opacity:0,filter:"blur(6px)"},expanded:{height:"auto",opacity:1,filter:"blur(0px)",transition:{height:{type:"spring",stiffness:400,damping:35,mass:1},opacity:{duration:.25,delay:.05},filter:{duration:.3,delay:.05}}}},p1={collapsed:{opacity:0,y:-15,filter:"blur(5px)"},expanded:{opacity:1,y:0,filter:"blur(0px)",transition:{type:"spring",stiffness:300,damping:25,delay:.08}}},g1={collapsed:{opacity:0},expanded:{opacity:1,transition:{staggerChildren:.05,delayChildren:.12}}},m1={collapsed:{opacity:0,x:-15,scale:.97,filter:"blur(4px)"},expanded:{opacity:1,x:0,scale:1,filter:"blur(0px)",transition:{type:"spring",stiffness:350,damping:25}}},h1=({data:b})=>{const[j,N]=Y.useState(new Set),p=Y.useRef(null),T=we(p,{once:!0,margin:"-100px"}),H=E=>{N(G=>{const k=new Set(G);return k.has(E)?k.delete(E):k.add(E),k})};return o.jsx(Kh,{id:"professionalexperience",ref:p,children:o.jsxs(Jh,{children:[o.jsx(Sa,{number:"03",title:"Experience",inView:T}),o.jsx($h,{children:b.timeline.map((E,G)=>{const k=j.has(G);return o.jsxs(Wh,{initial:{opacity:0,x:-30,filter:"blur(4px)"},whileInView:{opacity:1,x:0,filter:"blur(0px)"},viewport:{once:!0,margin:"-50px"},transition:{type:"spring",stiffness:100,damping:20,delay:.1},onClick:()=>H(G),whileHover:{x:8,transition:{type:"spring",stiffness:300,damping:25}},children:[o.jsx(Fh,{children:o.jsx(Ih,{children:E.date})}),o.jsxs(Ph,{children:[o.jsxs(t1,{children:[o.jsxs("div",{children:[o.jsx(e1,{children:o.jsx("a",{href:E.url,target:"_blank",rel:"noopener noreferrer",onClick:V=>V.stopPropagation(),children:E.title})}),o.jsx(l1,{children:E.subTitle}),E.previously&&o.jsxs(n1,{initial:{opacity:0,y:5},animate:{opacity:1,y:0},transition:{delay:.1},children:[o.jsx(i1,{children:"Previously:"}),o.jsx(u1,{children:E.previously})]})]}),o.jsx(a1,{$isOpen:k,animate:{rotate:k?45:0,scale:k?1.1:1},transition:{type:"spring",stiffness:400,damping:20},whileHover:{scale:1.15},whileTap:{scale:.95},children:o.jsx(v.svg,{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:o.jsx("path",{d:"M12 5v14M5 12h14"})})})]}),o.jsx(c1,{dangerouslySetInnerHTML:{__html:E.descriptionSummary}}),o.jsx(Ml,{initial:!1,children:k&&o.jsx(o1,{variants:d1,initial:"collapsed",animate:"expanded",exit:"collapsed",children:o.jsx(s1,{variants:p1,children:o.jsx(r1,{variants:g1,initial:"collapsed",animate:"expanded",exit:"collapsed",children:E.description.map((V,xt)=>o.jsx(f1,{variants:m1,children:V},xt))})})},"content")})]})]},G)})})]})})},Yd=qt`
  0% {
    background-position: 0% 50%;
  }
  50% {
...
`,db=d(v.p)`
  ...
  color: var(--text-secondary);
  transition: color 0.4s ease;
`,pb=({data:b})=>{const j=Y.useRef(null),N=we(j,{once:!0,margin:"-100px"});return o.jsx(ib,{id:"educationalqualifications",ref:j,children:o.jsxs(ub,{children:[o.jsx(Sa,{number:"07",title:"Education",inView:N}),o.jsx(cb,{children:b.timeline.map((p,T)=>o.jsxs(ob,{initial:{opacity:0,x:-30,filter:"blur(4px)"},whileInView:{opacity:1,x:0,filter:"blur(0px)"},viewport:{once:!0,margin:"-50px"},transition:{type:"spring",stiffness:100,damping:20,delay:T*.1},whileHover:{x:16,transition:{type:"spring",stiffness:400,damping:25}},children:[o.jsx(sb,{children:p.date}),o.jsxs(rb,{children:[o.jsx(fb,{children:p.title}),o.jsx(db,{children:p.subTitle})]})]},T))})]})})},Xd=qt`
  0% {
    background-position: 0% 50%;
  }
  50% {
