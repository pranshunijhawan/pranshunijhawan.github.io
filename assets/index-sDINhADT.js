const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/About-CVQwnl-M.js","assets/vendor-motion-BoSVoJ0s.js","assets/vendor-react-DlBnNAMw.js","assets/vendor-styled-Du6AN5G6.js","assets/Section-CwT4PFr4.js","assets/TechnologyProficiency-BRImPjB2.js","assets/ProfessionalExperience-C5tTARtV.js","assets/MostProudOf-D3-X0Z8g.js","assets/Certifications-CnsAJGvc.js","assets/Testimonials-ZcJoRRde.js","assets/EducationalQualifications-CbtYLg7Y.js","assets/Contact-C-Yn4A-o.js"])))=>i.map(i=>d[i]);
import{r as ht,j as x,m as _,A as Md,u as Pm,a as df,b as bd}from"./vendor-motion-BoSVoJ0s.js";import{r as th,a as ah}from"./vendor-react-DlBnNAMw.js";import{f as lh,m as xa,d as M,l as eh}from"./vendor-styled-Du6AN5G6.js";(function(){const K=document.createElement("link").relList;if(K&&K.supports&&K.supports("modulepreload"))return;for(const X of document.querySelectorAll('link[rel="modulepreload"]'))g(X);new MutationObserver(X=>{for(const N of X)if(N.type==="childList")for(const et of N.addedNodes)et.tagName==="LINK"&&et.rel==="modulepreload"&&g(et)}).observe(document,{childList:!0,subtree:!0});function F(X){const N={};return X.integrity&&(N.integrity=X.integrity),X.referrerPolicy&&(N.referrerPolicy=X.referrerPolicy),X.crossOrigin==="use-credentials"?N.credentials="include":X.crossOrigin==="anonymous"?N.credentials="omit":N.credentials="same-origin",N}function g(X){if(X.ep)return;X.ep=!0;const N=F(X);fetch(X.href,N)}})();var mf={exports:{}},xn={},hf={exports:{}},gf={};var Sd;function nh(){return Sd||(Sd=1,(function(S){function K(p,z){var O=p.length;p.push(z);t:for(;0<O;){var nt=O-1>>>1,it=p[nt];if(0<X(it,z))p[nt]=z,p[O]=it,O=nt;else break t}}function F(p){return p.length===0?null:p[0]}function g(p){if(p.length===0)return null;var z=p[0],O=p.pop();if(O!==z){p[0]=O;t:for(var nt=0,it=p.length,Ct=it>>>1;nt<Ct;){var ot=2*(nt+1)-1,J=p[ot],xt=ot+1,ya=p[xt];if(0>X(J,O))xt<it&&0>X(ya,J)?(p[nt]=ya,p[xt]=O,nt=xt):(p[nt]=J,p[ot]=O,nt=ot);else if(xt<it&&0>X(ya,O))p[nt]=ya,p[xt]=O,nt=xt;else break t}}return z}function X(p,z){var O=p.sortIndex-z.sortIndex;return O!==0?O:p.id-z.id}if(S.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var N=performance;S.unstable_now=function(){return N.now()}}else{var et=Date,Q=et.now();S.unstable_now=function(){return et.now()-Q}}var k=[],R=[],bt=1,U=null,at=3,ha=!1,Rt=!1,Ft=!1,Gl=!1,Yl=typeof setTimeout=="function"?setTimeout:null,Me=typeof clearTimeout=="function"?clearTimeout:null,It=typeof setImmediate<"u"?setImmediate:null;function Za(p){for(var z=F(R);z!==null;){if(z.callback===null)g(R);else if(z.startTime<=p)g(R),z.sortIndex=z.expirationTime,K(k,z);else break;z=F(R)}}function vl(p){if(Ft=!1,Za(p),!Rt)if(F(k)!==null)Rt=!0,ga||(ga=!0,Pt());else{var z=F(R);z!==null&&Aa(vl,z.startTime-p)}}var ga=!1,za=-1,sa=5,Ql=-1;function zn(){return Gl?!0:!(S.unstable_now()-Ql<sa)}function Rl(){if(Gl=!1,ga){var p=S.unstable_now();Ql=p;var z=!0;try{t:{Rt=!1,Ft&&(Ft=!1,Me(za),za=-1),ha=!0;var O=at;try{a:{for(Za(p),U=F(k);U!==null&&!(U.expirationTime>p&&zn());){var nt=U.callback;if(typeof nt=="function"){U.callback=null,at=U.priorityLevel;var it=nt(U.expirationTime<=p);if(p=S.unstable_now(),typeof it=="function"){U.callback=it,Za(p),z=!0;break a}U===F(k)&&g(k),Za(p)}else g(k);U=F(k)}if(U!==null)z=!0;else{var Ct=F(R);Ct!==null&&Aa(vl,Ct.startTime-p),z=!1}}break t}finally{U=null,at=O,ha=!1}z=void 0}}finally{z?Pt():ga=!1}}}var Pt;if(typeof It=="function")Pt=function(){It(Rl)};else if(typeof MessageChannel<"u"){var An=new MessageChannel,De=An.port2;An.port1.onmessage=Rl,Pt=function(){De.postMessage(null)}}else Pt=function(){Yl(Rl,0)};function Aa(p,z){za=Yl(function(){p(S.unstable_now())},z)}S.unstable_IdlePriority=5,S.unstable_ImmediatePriority=1,S.unstable_LowPriority=4,S.unstable_NormalPriority=3,S.unstable_Profiling=null,S.unstable_UserBlockingPriority=2,S.unstable_cancelCallback=function(p){p.callback=null},S.unstable_forceFrameRate=function(p){0>p||125<p?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):sa=0<p?Math.floor(1e3/p):5},S.unstable_getCurrentPriorityLevel=function(){return at},S.unstable_next=function(p){switch(at){case 1:case 2:case 3:var z=3;break;default:z=at}var O=at;at=z;try{return p()}finally{at=O}},S.unstable_requestPaint=function(){Gl=!0},S.unstable_runWithPriority=function(p,z){switch(p){case 1:case 2:case 3:case 4:case 5:break;default:p=3}var O=at;at=p;try{return z()}finally{at=O}},S.unstable_scheduleCallback=function(p,z,O){var nt=S.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?nt+O:nt):O=nt,p){case 1:var it=-1;break;case 2:it=250;break;case 5:it=1073741823;break;case 4:it=1e4;break;default:it=5e3}return it=O+it,p={id:bt++,callback:z,priorityLevel:p,startTime:O,expirationTime:it,sortIndex:-1},O>nt?(p.sortIndex=O,K(R,p),F(k)===null&&p===F(R)&&(Ft?(Me(za),za=-1):Ft=!0,Aa(vl,O-nt))):(p.sortIndex=it,K(k,p),Rt||ha||(Rt=!0,ga||(ga=!0,Pt()))),p},S.unstable_shouldYield=zn,S.unstable_wrapCallback=function(p){var z=at;return function(){var O=at;at=z;try{return p.apply(this,arguments)}finally{at=O}}}})(gf)),gf}var xd;function ih(){return xd||(xd=1,hf.exports=nh()),hf.exports}var zd;function uh(){if(zd)return xn;zd=1;var S=ih(),K=th(),F=ah();function g(t){var a="https://react.dev/errors/"+t;if(1<arguments.length){a+="?args[]="+encodeURIComponent(arguments[1]);for(var l=2;l<arguments.length;l++)a+="&args[]="+encodeURIComponent(arguments[l])}return"Minified React error #"+t+"; visit "+a+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function X(t){return!(!t||t.nodeType!==1&&t.nodeType!==9&&t.nodeType!==11)}function N(t){var a=t,l=t;if(t.alternate)for(;a.return;)a=a.return;else{t=a;do a=t,(a.flags&4098)!==0&&(l=a.return),t=a.return;while(t)}return a.tag===3?l:null}function et(t){if(t.tag===13){var a=t.memoizedState;if(a===null&&(t=t.alternate,t!==null&&(a=t.memoizedState)),a!==null)return a.dehydrated}return null}function Q(t){if(t.tag===31){var a=t.memoizedState;if(a===null&&(t=t.alternate,t!==null&&(a=t.memoizedState)),a!==null)return a.dehydrated}return null}function k(t){if(N(t)!==t)throw Error(g(188))}function R(t){var a=t.alternate;if(!a){if(a=N(t),a===null)throw Error(g(188));return a!==t?null:t}for(var l=t,e=a;;){var n=l.return;if(n===null)break;var i=n.alternate;if(i===null){if(e=n.return,e!==null){l=e;continue}break}if(n.child===i.child){for(i=n.child;i;){if(i===l)return k(n),t;if(i===e)return k(n),a;i=i.sibling}throw Error(g(188))}if(l.return!==e.return)l=n,e=i;else{for(var u=!1,c=n.child;c;){if(c===l){u=!0,l=n,e=i;break}if(c===e){u=!0,e=n,l=i;break}c=c.sibling}if(!u){for(c=i.child;c;){if(c===l){u=!0,l=i,e=n;break}if(c===e){u=!0,e=i,l=n;break}c=c.sibling}if(!u)throw Error(g(189))}}if(l.alternate!==e)throw Error(g(190))}if(l.tag!==3)throw Error(g(188));return l.stateNode.current===l?t:a}function bt(t){var a=t.tag;if(a===5||a===26||a===27||a===6)return t;for(t=t.child;t!==null;){if(a=bt(t),a!==null)return a;t=t.sibling}return null}var U=Object.assign,at=Symbol.for("react.element"),ha=Symbol.for("react.transitional.element"),Rt=Symbol.for("react.portal"),Ft=Symbol.for("react.fragment"),Gl=Symbol.for("react.strict_mode"),Yl=Symbol.for("react.profiler"),Me=Symbol.for("react.consumer"),It=Symbol.for("react.context"),Za=Symbol.for("react.forward_ref"),vl=Symbol.for("react.suspense"),ga=Symbol.for("react.suspense_list"),za=Symbol.for("react.memo"),sa=Symbol.for("react.lazy"),Ql=Symbol.for("react.activity"),zn=Symbol.for("react.memo_cache_sentinel"),Rl=Symbol.iterator;function Pt(t){return t===null||typeof t!="object"?null:(t=Rl&&t[Rl]||t["@@iterator"],typeof t=="function"?t:null)}var An=Symbol.for("react.client.reference");function De(t){if(t==null)return null;if(typeof t=="function")return t.$$typeof===An?null:t.displayName||t.name||null;if(typeof t=="string")return t;switch(t){case Ft:return"Fragment";case Yl:return"Profiler";case Gl:return"StrictMode";case vl:return"Suspense";case ga:return"SuspenseList";case Ql:return"Activity"}if(typeof t=="object")switch(t.$$typeof){case Rt:return"Portal";case It:return t.displayName||"Context";case Me:return(t._context.displayName||"Context")+".Consumer";case Za:var a=t.render;return t=t.displayName,t||(t=a.displayName||a.name||"",t=t!==""?"ForwardRef("+t+")":"ForwardRef"),t;case za:return a=t.displayName||null,a!==null?a:De(t.type)||"Memo";case sa:a=t._payload,t=t._init;try{return De(t(a))}catch{}}return null}var Aa=Array.isArray,p=K.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,z=F.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,O={pending:!1,data:null,method:null,action:null},nt=[],it=-1;function Ct(t){return{current:t}}function ot(t){0>it||(t.current=nt[it],nt[it]=null,it--)}function J(t,a){it++,nt[it]=t.current,t.current=a}var xt=Ct(null),ya=Ct(null),Va=Ct(null),Tn=Ct(null);function En(t,a){switch(J(Va,a),J(ya,t),J(xt,null),a.nodeType){case 9:case 11:t=(t=a.documentElement)&&(t=t.namespaceURI)?Xr(t):0;break;default:if(t=a.tagName,a=a.namespaceURI)a=Xr(a),t=Zr(a,t);else switch(t){case"svg":t=1;break;case"math":t=2;break;default:t=0}}ot(xt),J(xt,t)}function wl(){ot(xt),ot(ya),ot(Va)}function Ki(t){t.memoizedState!==null&&J(Tn,t);var a=xt.current,l=Zr(a,t.type);a!==l&&(J(ya,t),J(xt,l))}function Mn(t){ya.current===t&&(ot(xt),ot(ya)),Tn.current===t&&(ot(Tn),vn._currentValue=O)}var Ji,vf;function pl(t){if(Ji===void 0)try{throw Error()}catch(l){var a=l.stack.trim().match(/\n( *(at )?)/);Ji=a&&a[1]||"",vf=-1<l.stack.indexOf(`
...
`,Dd=ht.createContext(void 0),Od="portfolio-theme-mode",dh=()=>{if(typeof window<"u"){const S=localStorage.getItem(Od);if(S==="dark"||S==="light")return S}return"dark"},mh=({children:S})=>{const[K,F]=ht.useState(dh);ht.useEffect(()=>{document.documentElement.setAttribute("data-theme",K),localStorage.setItem(Od,K)},[K]);const g=()=>{F(X=>X==="dark"?"light":"dark")};return x.jsx(Dd.Provider,{value:{mode:K,toggleTheme:g,isDark:K==="dark"},children:S})},hh=()=>{const S=ht.useContext(Dd);if(!S)throw new Error("useTheme must be used within a ThemeProvider");return S},gh=xa`
  0% {
...
`,Ed=[{label:"About",href:"#about"},{label:"Skills",href:"#technologyproficiency"},{label:"Experience",href:"#professionalexperience"},{label:"Projects",href:"#mostproudof"},{label:"Contact",href:"#contact"}],Eh=()=>{const[S,K]=ht.useState(""),F=ht.useRef(null),{isDark:g,toggleTheme:X}=hh();ht.useEffect(()=>{const Q=()=>{const k=Ed.map(R=>R.href.replace("#",""));for(const R of[...k].reverse()){const bt=document.getElementById(R);if(bt&&bt.getBoundingClientRect().top<=150){K(R);return}}K("")};return window.addEventListener("scroll",Q,{passive:!0}),()=>window.removeEventListener("scroll",Q)},[]);const N=Q=>{const k=Q.currentTarget.getBoundingClientRect(),R=(Q.clientX-k.left)/k.width*100,bt=(Q.clientY-k.top)/k.height*100;Q.currentTarget.style.setProperty("--mouse-x",`${R}%`),Q.currentTarget.style.setProperty("--mouse-y",`${bt}%`)},et=(Q,k)=>{Q.preventDefault(),document.querySelector(k)?.scrollIntoView({behavior:"smooth"})};return x.jsx(vh,{ref:F,children:x.jsxs(ph,{"aria-label":"Main navigation",initial:{opacity:0,y:-20,scale:.95},animate:{opacity:1,y:0,scale:1},transition:{duration:.6,ease:[.25,.1,.25,1],delay:.2},children:[x.jsx(bh,{href:"#home",onClick:Q=>et(Q,"#home"),whileHover:{scale:1.05},whileTap:{scale:.95},children:x.jsx(Sh,{src:"/images/logo.png",alt:"PN",width:28,height:28,loading:"eager",decoding:"async"})}),x.jsx(xh,{children:Ed.map(Q=>{const k=S===Q.href.replace("#","");return x.jsxs(zh,{href:Q.href,$isActive:k,"aria-current":k?"page":void 0,onClick:R=>et(R,Q.href),onMouseMove:N,whileHover:{scale:1.02},whileTap:{scale:.98},children:[k&&x.jsx(Ah,{layoutId:"navActive",initial:!1,transition:{type:"spring",stiffness:500,damping:35}}),x.jsx("span",{style:{position:"relative",zIndex:1},children:Q.label})]},Q.label)})}),x.jsx(Th,{onClick:X,whileHover:{scale:1.05},whileTap:{scale:.95},title:g?"Switch to light mode":"Switch to dark mode","aria-label":g?"Switch to light mode":"Switch to dark mode",role:"button",children:x.jsx(Md,{mode:"wait",children:g?x.jsxs(_.svg,{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",initial:{rotate:-90,opacity:0},animate:{rotate:0,opacity:1},exit:{rotate:90,opacity:0},transition:{duration:.3},children:[x.jsx("circle",{cx:"12",cy:"12",r:"5"}),x.jsx("path",{d:"M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"})]},"sun"):x.jsx(_.svg,{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",initial:{rotate:90,opacity:0},animate:{rotate:0,opacity:1},exit:{rotate:-90,opacity:0},transition:{duration:.3},children:x.jsx("path",{d:"M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"})},"moon")})})]})})},Ud=xa`
  0% {
...
`,Jh={initial:{opacity:1},animate:{opacity:1},exit:{opacity:0,transition:{duration:.6,ease:[.4,0,.2,1],when:"afterChildren"}}},kh={initial:{opacity:0,scale:1.5},animate:{opacity:1,scale:1,transition:{duration:1.5}},exit:{opacity:0,scale:.9,transition:{duration:.5,ease:[.4,0,.2,1]}}},$h={initial:{},animate:{},exit:{scale:.8,opacity:0,filter:"blur(15px)",transition:{duration:.5,ease:[.4,0,.2,1]}}},Wh={initial:{opacity:0,scale:.5},animate:{opacity:1,scale:1,transition:{duration:.8,ease:[.25,.1,.25,1]}}},Fh={initial:{opacity:0,scale:0,rotate:-180},animate:{opacity:1,scale:1,rotate:0,transition:{type:"spring",stiffness:100,damping:15,delay:.2}}},Ih={initial:{opacity:0,scale:.3,rotateY:-90,filter:"blur(10px)"},animate:{opacity:1,scale:1,rotateY:0,filter:"blur(0px)",transition:{type:"spring",stiffness:80,damping:12,delay:.4}}},Ph=({onComplete:S})=>{const[K,F]=ht.useState(!0),g=Array.from({length:20},(N,et)=>({id:et,x:Math.random()*100,y:Math.random()*100,size:Math.random()*4+2,color:et%3===0?"rgba(42, 157, 143, 0.4)":et%3===1?"rgba(59, 180, 177, 0.3)":"rgba(67, 97, 165, 0.3)",duration:Math.random()*3+2,delay:Math.random()*2}));ht.useEffect(()=>{const N=setTimeout(()=>{F(!1)},2200);return()=>clearTimeout(N)},[]);const X=()=>{S()};return x.jsx(Md,{onExitComplete:X,children:K&&x.jsxs(Gh,{variants:Jh,initial:"initial",animate:"animate",exit:"exit",children:[x.jsx(Yh,{variants:kh,initial:"initial",animate:"animate",exit:"exit"}),x.jsx(Qh,{initial:{opacity:1},exit:{opacity:0,transition:{duration:.3}},children:g.map(N=>x.jsx(Rh,{$size:N.size,$color:N.color,style:{left:`${N.x}%`,top:`${N.y}%`},initial:{opacity:0,scale:0},animate:{opacity:[0,.8,0],scale:[0,1,0],y:[0,-100]},transition:{duration:N.duration,delay:N.delay,repeat:1/0,repeatDelay:Math.random()*2}},N.id))}),x.jsx(wh,{variants:$h,initial:"initial",animate:"animate",exit:"exit",children:x.jsxs(Xh,{children:[x.jsx(Zh,{variants:Wh,initial:"initial",animate:"animate"}),x.jsx(yf,{}),x.jsx(yf,{}),x.jsx(yf,{}),x.jsx(Vh,{variants:Fh,initial:"initial",animate:"animate"}),x.jsx(Lh,{src:"/images/logo.png",alt:"PN",width:80,height:80,loading:"eager",decoding:"async",variants:Ih,initial:"initial",animate:"animate"}),x.jsx(Kh,{initial:{opacity:0},animate:{opacity:1},transition:{delay:.8,duration:.5}})]})})]})})},tg=xa`
  0% {
