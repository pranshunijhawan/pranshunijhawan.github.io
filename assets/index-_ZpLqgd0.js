...
`,qf=R.createContext(void 0),_f="portfolio-theme-mode",kp=()=>{if(typeof window<"u"){const g=localStorage.getItem(_f);if(g==="dark"||g==="light")return g}return"dark"},Dp=({children:g})=>{const[T,H]=R.useState(kp);R.useEffect(()=>{document.documentElement.setAttribute("data-theme",T),localStorage.setItem(_f,T)},[T]);const p=()=>{H(E=>E==="dark"?"light":"dark")};return u.jsx(qf.Provider,{value:{mode:T,toggleTheme:p,isDark:T==="dark"},children:g})},Cp=()=>{const g=R.useContext(qf);if(!g)throw new Error("useTheme must be used within a ThemeProvider");return g},Rf=ut`
  0% {
    background-position: -200% center;
  }
  100% {
...
`,Tb={collapsed:{height:0,opacity:0,filter:"blur(6px)"},expanded:{height:"auto",opacity:1,filter:"blur(0px)",transition:{height:{type:"spring",stiffness:400,damping:35,mass:1},opacity:{duration:.25,delay:.05},filter:{duration:.3,delay:.05}}}},Eb={collapsed:{opacity:0,y:-15,filter:"blur(5px)"},expanded:{opacity:1,y:0,filter:"blur(0px)",transition:{type:"spring",stiffness:300,damping:25,delay:.08}}},jb={collapsed:{opacity:0},expanded:{opacity:1,transition:{staggerChildren:.05,delayChildren:.12}}},Mb={collapsed:{opacity:0,x:-15,scale:.97,filter:"blur(4px)"},expanded:{opacity:1,x:0,scale:1,filter:"blur(0px)",transition:{type:"spring",stiffness:350,damping:25}}},kb=({data:g})=>{const[T,H]=R.useState(new Set),p=R.useRef(null),E=xa(p,{once:!0,margin:"-100px"}),C=M=>{H(Y=>{const G=new Set(Y);return G.has(M)?G.delete(M):G.add(M),G})};return u.jsx(rb,{id:"professionalexperience",ref:p,children:u.jsxs(ob,{children:[u.jsx(we,{number:"03",title:"Experience",inView:E}),u.jsx(ub,{children:g.timeline.map((M,Y)=>{const G=T.has(Y);return u.jsxs(cb,{initial:{opacity:0,x:-30,filter:"blur(4px)"},whileInView:{opacity:1,x:0,filter:"blur(0px)"},viewport:{once:!0,margin:"-50px"},transition:{type:"spring",stiffness:100,damping:20,delay:.1},onClick:()=>C(Y),whileHover:{x:8,transition:{type:"spring",stiffness:300,damping:25}},children:[u.jsx(sb,{children:u.jsx(db,{children:M.date})}),u.jsxs(fb,{children:[u.jsxs(gb,{children:[u.jsxs("div",{children:[u.jsx(pb,{children:u.jsx("a",{href:M.url,target:"_blank",rel:"noopener noreferrer",onClick:Q=>Q.stopPropagation(),children:M.title})}),u.jsx(hb,{children:M.subTitle}),M.previously&&u.jsxs(bb,{initial:{opacity:0,y:5},animate:{opacity:1,y:0},transition:{delay:.1},children:[u.jsx(vb,{children:"Previously:"}),u.jsx(yb,{children:M.previously})]})]}),u.jsx(mb,{$isOpen:G,animate:{rotate:G?45:0,scale:G?1.1:1},transition:{type:"spring",stiffness:400,damping:20},whileHover:{scale:1.15},whileTap:{scale:.95},children:u.jsx(v.svg,{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:u.jsx("path",{d:"M12 5v14M5 12h14"})})})]}),u.jsx(xb,{dangerouslySetInnerHTML:{__html:M.descriptionSummary}}),u.jsx(Di,{initial:!1,children:G&&u.jsx(Sb,{variants:Tb,initial:"collapsed",animate:"expanded",exit:"collapsed",children:u.jsx(zb,{variants:Eb,children:u.jsx(wb,{variants:jb,initial:"collapsed",animate:"expanded",exit:"collapsed",children:M.description.map((Q,At)=>u.jsx(Ab,{variants:Mb,children:Q},At))})})},"content")})]})]},Y)})})]})})},$f=ut`
  0% {
    background-position: 0% 50%;
  }
  50% {
...
`,Nb=d(v.article)`
  ...
  overflow: hidden;
  position: relative;
  animation: ${Db} 4s ease-in-out infinite;
...
`,$b={enter:g=>({x:g>0?80:-80,opacity:0,scale:.98}),center:{x:0,opacity:1,scale:1,transition:{type:"spring",stiffness:500,damping:35,mass:.8}},exit:g=>({x:g<0?80:-80,opacity:0,scale:.98,transition:{type:"spring",stiffness:500,damping:35,mass:.8}})},Kb={collapsed:{height:0,opacity:0,filter:"blur(6px)"},expanded:{height:"auto",opacity:1,filter:"blur(0px)",transition:{height:{type:"spring",stiffness:400,damping:35},opacity:{duration:.25,delay:.05},filter:{duration:.3,delay:.05}}}},Jb={collapsed:{opacity:0,y:-15,filter:"blur(5px)"},expanded:{opacity:1,y:0,filter:"blur(0px)",transition:{type:"spring",stiffness:300,damping:25,delay:.1}}},Wb={collapsed:{opacity:0},expanded:{opacity:1,transition:{staggerChildren:.05,delayChildren:.15}}},Fb={collapsed:{opacity:0,x:-20,scale:.97,filter:"blur(4px)"},expanded:{opacity:1,x:0,scale:1,filter:"blur(0px)",transition:{type:"spring",stiffness:350,damping:25}}},Ib=({data:g})=>{const[[T,H],p]=R.useState([0,0]),[E,C]=R.useState(!1),[M,Y]=R.useState(!1),G=R.useRef(null),Q=R.useRef(null),At=R.useRef(0),k=xa(G,{once:!0,margin:"-100px"}),K=R.useCallback(mt=>{if(M)return;const J=T+mt;J>=0&&J<g.content.length&&(Y(!0),p([J,mt]),C(!1),setTimeout(()=>Y(!1),350))},[T,g.content.length,M]),Lt=R.useCallback(mt=>{if(M||mt===T)return;const J=mt>T?1:-1;Y(!0),p([mt,J]),C(!1),setTimeout(()=>Y(!1),350)},[T,M]);R.useEffect(()=>{const mt=Q.current;if(!mt)return;const J=St=>{const bt=Date.now();if(bt-At.current<300)return;const Dt=Math.abs(St.deltaX)>Math.abs(St.deltaY)?St.deltaX:St.deltaY;if(Math.abs(Dt)>20){const ua=T<g.content.length-1,Sa=T>0;(Dt>0&&ua||Dt<0&&Sa)&&(St.preventDefault(),St.stopPropagation(),At.current=bt,Dt>0?K(1):K(-1))}};return mt.addEventListener("wheel",J,{passive:!1}),()=>mt.removeEventListener("wheel",J)},[T,g.content.length,K]);const I=R.useCallback((mt,J)=>{if(M)return;const St=30,bt=200;J.velocity.x>bt||J.offset.x>St?T>0&&K(-1):(J.velocity.x<-bt||J.offset.x<-St)&&T<g.content.length-1&&K(1)},[T,g.content.length,M,K]),Ut=g.content[T];return u.jsx(Ob,{id:"mostproudof",ref:G,children:u.jsxs(Hb,{children:[u.jsx(we,{number:"04",title:"Projects",inView:k}),u.jsxs(Bb,{initial:{opacity:0,y:40},animate:k?{opacity:1,y:0}:{},transition:{type:"spring",stiffness:80,damping:20,delay:.2},children:[u.jsx(Ub,{ref:Q,children:u.jsx(Di,{initial:!1,custom:H,mode:"wait",children:u.jsxs(Nb,{custom:H,variants:$b,initial:"enter",animate:"center",exit:"exit",drag:"x",dragConstraints:{left:0,right:0},dragElastic:.1,dragMomentum:!1,onDragEnd:I,transition:{x:{type:"spring",stiffness:500,damping:35,mass:.8},opacity:{duration:.2},scale:{type:"spring",stiffness:500,damping:35,mass:.8}},style:{cursor:"grab",touchAction:"pan-y"},whileDrag:{cursor:"grabbing",scale:1.01},children:[u.jsxs(Gb,{$isExpanded:E,onClick:()=>C(!E),whileHover:{scale:1.01},transition:{type:"spring",stiffness:400,damping:25},children:[u.jsx(qb,{children:Ut.title}),u.jsx(_b,{$isExpanded:E,"aria-label":E?"Collapse project details":"Expand project details","aria-expanded":E,animate:{rotate:E?45:0,scale:E?1.1:1},transition:{type:"spring",stiffness:400,damping:20},whileHover:{scale:1.15},whileTap:{scale:.95},children:u.jsx(v.svg,{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2","aria-hidden":"true",children:u.jsx("path",{d:"M12 5v14M5 12h14"})})})]}),u.jsx(Di,{initial:!1,children:E&&u.jsx(Rb,{variants:Kb,initial:"collapsed",animate:"expanded",exit:"collapsed",children:u.jsx(Yb,{variants:Jb,children:u.jsx(Xb,{variants:Wb,initial:"collapsed",animate:"expanded",exit:"collapsed",children:Ut.content.map((mt,J)=>u.jsx(Lb,{variants:Fb,children:mt},J))})})})})]},T)})}),u.jsxs(Qb,{initial:{opacity:0,y:20},animate:k?{opacity:1,y:0}:{},transition:{type:"spring",stiffness:100,damping:20,delay:.4},children:[u.jsx(Nf,{onClick:()=>K(-1),disabled:T===0,"aria-label":"Previous project",whileHover:{scale:1.1},whileTap:{scale:.95},transition:{type:"spring",stiffness:400,damping:25},children:u.jsx("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2","aria-hidden":"true",children:u.jsx("path",{d:"M19 12H5M12 19l-7-7 7-7"})})}),u.jsx(Vb,{role:"tablist","aria-label":"Project navigation",children:g.content.map((mt,J)=>u.jsx(Zb,{$isActive:T===J,onClick:()=>Lt(J),role:"tab","aria-selected":T===J,"aria-label":`Go to project ${J+1}: ${mt.title}`,whileHover:{scale:1.1},whileTap:{scale:.95},animate:{width:T===J?36:12},transition:{type:"spring",stiffness:400,damping:25}},J))}),u.jsx(Nf,{onClick:()=>K(1),disabled:T===g.content.length-1,"aria-label":"Next project",whileHover:{scale:1.1},whileTap:{scale:.95},transition:{type:"spring",stiffness:400,damping:25},children:u.jsx("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2","aria-hidden":"true",children:u.jsx("path",{d:"M5 12h14M12 5l7 7-7 7"})})})]})]})]})})},Pb=ut`
  0% {
    background-position: -200% center;
  }
  100% {
...
`,uv=({data:g})=>{const T=R.useRef(null),H=xa(T,{once:!0,margin:"-100px"}),p=E=>E.toLowerCase().includes("azure")||E.toLowerCase().includes("microsoft")?"Microsoft":E.toLowerCase().includes("aws")?"Amazon Web Services":"";return u.jsx(tv,{id:"certifications",ref:T,children:u.jsxs(av,{children:[u.jsx(we,{number:"05",title:"Certifications",inView:H}),u.jsx(ev,{children:g.certificateProps.certificateMetaData.map((E,C)=>u.jsxs(iv,{initial:{opacity:0,x:-30,filter:"blur(4px)"},whileInView:{opacity:1,x:0,filter:"blur(0px)"},viewport:{once:!0,margin:"-50px"},transition:{type:"spring",stiffness:100,damping:20,delay:C*.08},whileHover:{x:12,transition:{type:"spring",stiffness:400,damping:25}},children:[u.jsxs(nv,{children:[u.jsx(lv,{children:E.title}),u.jsx(rv,{children:p(E.title)})]}),u.jsxs(ov,{href:E.buttonProps.link,target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.05},whileTap:{scale:.98},transition:{type:"spring",stiffness:400,damping:25},children:[u.jsx("span",{children:"Verify"}),u.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[u.jsx("path",{d:"M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6"}),u.jsx("polyline",{points:"15,3 21,3 21,9"}),u.jsx("line",{x1:"10",y1:"14",x2:"21",y2:"3"})]})]})]},C))})]})})},Kf=ut`
  0% {
    background-position: 0% 50%;
  }
  50% {
...
`,bv=d(v.span)`
  ...
  color: var(--text-tertiary);
  transition: color var(--timing-medium) var(--ease-standard);
`,vv=({data:g})=>{const T=R.useRef(null),H=xa(T,{once:!0,margin:"-100px"});return u.jsx(cv,{id:"testimonials",ref:T,children:u.jsxs(sv,{children:[u.jsx(we,{number:"06",title:"Testimonials",inView:H}),u.jsx(dv,{children:g.quoteProps.quoteMetaData.map((p,E)=>u.jsxs(fv,{initial:{opacity:0,y:40,filter:"blur(4px)"},whileInView:{opacity:1,y:0,filter:"blur(0px)"},viewport:{once:!0,margin:"-50px"},transition:{type:"spring",stiffness:100,damping:20,delay:E*.1},whileHover:{y:-8,scale:1.02,transition:{type:"spring",stiffness:300,damping:20}},children:[u.jsx(gv,{children:'"'}),u.jsx(pv,{children:p.quote}),u.jsxs(mv,{children:[u.jsx(hv,{children:p.givenBy}),u.jsx(bv,{children:p.subTitleGivenBy})]})]},E))})]})})},yv=d.section`
  padding: 64px 24px;
  background: var(--bg-secondary);
  transition: background-color var(--timing-medium) var(--ease-standard);
  position: relative;
...
`,Ev=d(v.p)`
  ...
  color: var(--text-secondary);
  transition: color var(--timing-medium) var(--ease-standard);
`,jv=({data:g})=>{const T=R.useRef(null),H=xa(T,{once:!0,margin:"-100px"});return u.jsx(yv,{id:"educationalqualifications",ref:T,children:u.jsxs(xv,{children:[u.jsx(we,{number:"07",title:"Education",inView:H}),u.jsx(Sv,{children:g.timeline.map((p,E)=>u.jsxs(zv,{initial:{opacity:0,x:-30,filter:"blur(4px)"},whileInView:{opacity:1,x:0,filter:"blur(0px)"},viewport:{once:!0,margin:"-50px"},transition:{type:"spring",stiffness:100,damping:20,delay:E*.1},whileHover:{x:16,transition:{type:"spring",stiffness:400,damping:25}},children:[u.jsx(wv,{children:p.date}),u.jsxs(Av,{children:[u.jsx(Tv,{children:p.title}),u.jsx(Ev,{children:p.subTitle})]})]},E))})]})})},Mv=ut`
  0% {
    background-position: 0% 50%;
  }
  50% {
...
`,qv=d(v.div)`
  ...
  position: relative;
  z-index: 1;
  animation: ${kv} 4s ease-in-out infinite;
